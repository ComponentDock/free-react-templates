...
**Status:** 108 / 1646 templates recreated · **1538 remaining**.
...
| 50  | **Foundry**        | Recreation of ColorLib "Architect" website template design.                                                                                          | Architects, Construction                                          | [foundry.surge.sh](https://free-react-templates-foundry.surge.sh)               |
| 51  | **Foyer**          | Recreation of ColorLib "Interior" website template design.                                                                                           | Architects, Interior Design                                       | [foyer.surge.sh](https://free-react-templates-foyer.surge.sh)                   |
| 52  | **Gaas**           | Recreation of ColorLib "GaaS" website template design.                                                                                               | App Landing Page, Bootstrap, Business, Landing Page               | [gaas.surge.sh](https://free-react-templates-gaas.surge.sh)                     |
| 53  | **Gable**          | Recreation of ColorLib "Kd" website template design (source: https://colorlib.com/wp/template/kd/).                                                  | Architects, Business, Interior Design                             | [gable.surge.sh](https://free-react-templates-gable.surge.sh)                   |
| 54  | **Girder**         | Recreation of ColorLib "Constructed" website template design.                                                                                        | Architects, Bootstrap 5                                           | [girder.surge.sh](https://free-react-templates-girder.surge.sh)                 |
| 55  | **Glitch**         | Recreation of ColorLib "Colorlib Error 404 V6" error page design.                                                                                    | 404 Error                                                         | [glitch.surge.sh](https://free-react-templates-glitch.surge.sh)                 |
| 56  | **Glow**           | Recreation of ColorLib "Colorlib Error 404 V8" error page design.                                                                                    | 404 Error                                                         | [glow.surge.sh](https://free-react-templates-glow.surge.sh)                     |
| 57  | **Halcyon**        | Recreation of ColorLib "Wellspa" website template design.                                                                                            | Beauty, Bootstrap, Business, Health Fitness                       | [halcyon.surge.sh](https://free-react-templates-halcyon.surge.sh)               |
| 58  | **Horse-club**     | Recreation of ColorLib "Horse Club" design.                                                                                                          | Animal, Business                                                  | [horse-club.surge.sh](https://free-react-templates-horse-club.surge.sh)         |
| 59  | **Itkol**          | Recreation of ColorLib "IT-Solution" (Itkol) website template design.                                                                                | App Landing Page, Business, Landing Page                          | [itkol.surge.sh](https://free-react-templates-itkol.surge.sh)                   |
| 60  | **Keynote**        | Recreation of ColorLib "Ai Summit" website template design.                                                                                          | Astro, Event, Tailwind Css                                        | [keynote.surge.sh](https://free-react-templates-keynote.surge.sh)               |
| 61  | **Keystone**       | Recreation of ColorLib "Archi" website template design, built under a **different name** with the monorepo stack: Vite + React 19 + Tailwind CSS 4.  | Architects, Interior Design                                       | [keystone.surge.sh](https://free-react-templates-keystone.surge.sh)             |
| 62  | **Lagoon**         | Recreation of ColorLib "Colorlib Error 404 V17" error page design.                                                                                   | 404 Error                                                         | [lagoon.surge.sh](https://free-react-templates-lagoon.surge.sh)                 |
| 63  | **Landing**        | It is an original React recreation of the ColorLib "Landing Page Wordpress Themes" entry in TEMPLATES.md (App Landing Page category).                | App Landing Page, Bootstrap, Business, Landing Page, One Page     | [landing.surge.sh](https://free-react-templates-landing.surge.sh)               |
| 64  | **Launch**         | Recreation of ColorLib "Launch" website template design.                                                                                             | App Landing Page                                                  | [launch.surge.sh](https://free-react-templates-launch.surge.sh)                 |
| 65  | **Leopet**         | Recreation of ColorLib "Leopet" design.                                                                                                              | Animal, Bootstrap                                                 | [leopet.surge.sh](https://free-react-templates-leopet.surge.sh)                 |
| 66  | **Lintel**         | Recreation of ColorLib "Marga" website template design, built under a **different name** with the monorepo stack: Vite + React 19 + Tailwind CSS 4 … | Architects, Bootstrap, Business                                   | [lintel.surge.sh](https://free-react-templates-lintel.surge.sh)                 |
| 67  | **Lustre**         | Recreation of ColorLib "Vogue" website template design.                                                                                              | Beauty                                                            | [lustre.surge.sh](https://free-react-templates-lustre.surge.sh)                 |
| 68  | **Maison**         | Recreation of ColorLib "Loaft" website template design (https://colorlib.com/wp/template/loaft/), built under a **different name** ("Maison") with … | Architects, Interior Design                                       | [maison.surge.sh](https://free-react-templates-maison.surge.sh)                 |
| 69  | **Masonry**        | Recreation of ColorLib "Astral" website template design.                                                                                             | Architects                                                        | [masonry.surge.sh](https://free-react-templates-masonry.surge.sh)               |
| 70  | **Massive**        | Recreation of ColorLib "Massive" website template design.                                                                                            | App Landing Page, One Page                                        | [massive.surge.sh](https://free-react-templates-massive.surge.sh)               |
| 71  | **Medora**         | It is an original React recreation of the ColorLib "Medical Wordpress Themes" category design.                                                       | Beauty, Health Fitness, Medical                                   | [medora.surge.sh](https://free-react-templates-medora.surge.sh)                 |
| 72  | **Mint**           | Recreation of ColorLib "Interior Design" website template design (source: https://colorlib.com/wp/template/interior-design/).                        | Architects, Business, Interior Design                             | [mint.surge.sh](https://free-react-templates-mint.surge.sh)                     |
| 73  | **Mosh**           | Recreation of ColorLib "Mosh" website template design.                                                                                               | App Landing Page, Bootstrap, Business, Landing Page, Startup      | [mosh.surge.sh](https://free-react-templates-mosh.surge.sh)                     |
| 74  | **Nova**           | Recreation of ColorLib "Colorlib Error 404 V19" error page design.                                                                                   | 404 Error                                                         | [nova.surge.sh](https://free-react-templates-nova.surge.sh)                     |
| 75  | **Onepage**        | It is an original React recreation of the ColorLib "One Page Wordpress Themes" entry in TEMPLATES.md (App Landing Page category).                    | App Landing Page, Landing Page, One Page, Startup                 | [onepage.surge.sh](https://free-react-templates-onepage.surge.sh)               |
| 76  | **Orbit**          | Recreation of ColorLib "Colorlib Error 404 10" error page design.                                                                                    | 404 Error                                                         | [orbit.surge.sh](https://free-react-templates-orbit.surge.sh)                   |
| 77  | **Pawcare**        | Recreation of ColorLib "Anipat" website template design.                                                                                             | Animal                                                            | [pawcare.surge.sh](https://free-react-templates-pawcare.surge.sh)               |
| 78  | **Pawpal**         | Recreation of ColorLib "PawPal" design.                                                                                                              | Animal, Astro, Tailwind Css                                       | [pawpal.surge.sh](https://free-react-templates-pawpal.surge.sh)                 |
| 79  | **Petcare**        | Recreation of ColorLib "Petcare" design.                                                                                                             | Animal                                                            | [petcare.surge.sh](https://free-react-templates-petcare.surge.sh)               |
| 80  | **Petsitting**     | Recreation of ColorLib "Petsitting" design.                                                                                                          | Animal, Bootstrap 5                                               | [petsitting.surge.sh](https://free-react-templates-petsitting.surge.sh)         |
| 81  | **Petvet**         | Recreation of ColorLib "Petvet" design.                                                                                                              | Animal, Business                                                  | [petvet.surge.sh](https://free-react-templates-petvet.surge.sh)                 |
| 82  | **Pinnacle**       | Recreation of ColorLib "Sparsh" website template design.                                                                                             | Architects, Interior Design                                       | [pinnacle.surge.sh](https://free-react-templates-pinnacle.surge.sh)             |
| 83  | **Pop**            | Recreation of ColorLib "Colorlib Error 404 V7" error page design.                                                                                    | 404 Error                                                         | [pop.surge.sh](https://free-react-templates-pop.surge.sh)                       |
| 84  | **Postie**         | Recreation of ColorLib **"Standout"** website template design (https://colorlib.com/wp/template/standout/), built under a DIFFERENT name ("Postie" … | App Landing Page, Business                                        | [postie.surge.sh](https://free-react-templates-postie.surge.sh)                 |
| 85  | **Punch**          | Recreation of ColorLib "Colorlib Error 404 V4" error page design.                                                                                    | 404 Error                                                         | [punch.surge.sh](https://free-react-templates-punch.surge.sh)                   |
| 86  | **Query**          | Recreation of ColorLib "Colorlib Error 404 V5" error page design.                                                                                    | 404 Error                                                         | [query.surge.sh](https://free-react-templates-query.surge.sh)                   |
| 87  | **Rafter**         | Recreation of ColorLib "Woodrox" website template design.                                                                                            | Architects, Interior Design                                       | [rafter.surge.sh](https://free-react-templates-rafter.surge.sh)                 |
| 88  | **Scarlet**        | Recreation of ColorLib "Colorlib Error 404 V16" error page design.                                                                                   | 404 Error                                                         | [scarlet.surge.sh](https://free-react-templates-scarlet.surge.sh)               |
| 89  | **Schola**         | Recreation of ColorLib "Academix" website template design.                                                                                           | Astro, Education, Tailwind Css                                    | [schola.surge.sh](https://free-react-templates-schola.surge.sh)                 |
| 90  | **Showkit**        | Recreation of ColorLib "SuSan" website template design, built under a **different name** with the monorepo stack: Vite + React 19 + Tailwind CSS 4 … | App Landing Page, Landing Page                                    | [showkit.surge.sh](https://free-react-templates-showkit.surge.sh)               |
| 91  | **Sky**            | Recreation of ColorLib "Colorlib Error 404 V2" error page design.                                                                                    | 404 Error                                                         | [sky.surge.sh](https://free-react-templates-sky.surge.sh)                       |
| 92  | **Skyline**        | Recreation of ColorLib "Dreamrs" website template design (source: https://colorlib.com/wp/template/dreamrs/), built under a DIFFERENT name with the… | Architects, Interior Design, Real Estate                          | [skyline.surge.sh](https://free-react-templates-skyline.surge.sh)               |
| 93  | **Slice**          | Recreation of ColorLib "Colorlib Error 404 V3" error page design.                                                                                    | 404 Error                                                         | [slice.surge.sh](https://free-react-templates-slice.surge.sh)                   |
| 94  | **Soar**           | Recreation of ColorLib "Raptor" website template design, built under a **different name** with the monorepo stack: Vite + React 19 + Tailwind CSS 4… | App Landing Page, Bootstrap, Landing Page, Web Hosting            | [soar.surge.sh](https://free-react-templates-soar.surge.sh)                     |
| 95  | **Synapse**        | Recreation of ColorLib "Nexus" website template design, built under a **different name** (Synapse) with the monorepo stack: Vite + React 19 + Tailw… | App Landing Page, Bootstrap, Landing Page                         | [synapse.surge.sh](https://free-react-templates-synapse.surge.sh)               |
| 96  | **Tears**          | Recreation of ColorLib "Colorlib Error 404 V12" error page design.                                                                                   | 404 Error                                                         | [tears.surge.sh](https://free-react-templates-tears.surge.sh)                   |
| 97  | **Terracotta**     | Recreation of ColorLib "Heaven" website template design (source: https://colorlib.com/wp/template/heaven/).                                          | Architects, Bootstrap, Business, Interior Design                  | [terracotta.surge.sh](https://free-react-templates-terracotta.surge.sh)         |
| 98  | **Tessera**        | Recreation of ColorLib "Mosaic" website template design.                                                                                             | Architects, Business, Interior Design                             | [tessera.surge.sh](https://free-react-templates-tessera.surge.sh)               |
| 99  | **Thepetcare**     | Recreation of ColorLib "Thepetcare" design.                                                                                                          | Animal                                                            | [thepetcare.surge.sh](https://free-react-templates-thepetcare.surge.sh)         |
| 100 | **Trellis**        | Recreation of ColorLib "Monarch" website template design.                                                                                            | Architects                                                        | [trellis.surge.sh](https://free-react-templates-trellis.surge.sh)               |
| 101 | **Trestle**        | Recreation of ColorLib "Arcade" website template design.                                                                                             | Architects, Business, Construction                                | [trestle.surge.sh](https://free-react-templates-trestle.surge.sh)               |
| 102 | **Truss**          | Recreation of ColorLib "Kraft" website template design.                                                                                              | Architects                                                        | [truss.surge.sh](https://free-react-templates-truss.surge.sh)                   |
| 103 | **Verve**          | Recreation of ColorLib "Racks" website template design (https://colorlib.com/wp/template/racks/), built under a **different name** with the monorep… | App Landing Page, Bootstrap, Business, Startup                    | [verve.surge.sh](https://free-react-templates-verve.surge.sh)                   |
| 104 | **Villa**          | Recreation of ColorLib "Layal" website template design.                                                                                              | Architects, Creative                                              | [villa.surge.sh](https://free-react-templates-villa.surge.sh)                   |
| 105 | **Violet**         | Recreation of ColorLib **"Sierra"** website template design (https://colorlib.com/wp/template/sierra/), built under a DIFFERENT name ("Violet" — th… | App Landing Page, Bootstrap, Business, Landing Page, Startup      | [violet.surge.sh](https://free-react-templates-violet.surge.sh)                 |
| 106 | **Vista**          | Recreation of ColorLib "Colorlib Error 404 V11" error page design.                                                                                   | 404 Error                                                         | [vista.surge.sh](https://free-react-templates-vista.surge.sh)                   |
| 107 | **Wordpressapp**   | It is an original React recreation of the ColorLib "Wordpress App Themes" entry in TEMPLATES.md (App Landing Page category).                         | App Landing Page, Bootstrap, Landing Page, One Page, Seo, Startup | [wordpressapp.surge.sh](https://free-react-templates-wordpressapp.surge.sh)     |
| 108 | **Zest**           | Recreation of ColorLib "Zeedapp" website template design, built under the new name **Zest** with the monorepo stack: Vite + React 19 + Tailwind CSS… | App Landing Page, Bootstrap, Landing Page, One Page               | [zest.surge.sh](https://free-react-templates-zest.surge.sh)                     |
