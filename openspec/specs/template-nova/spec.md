...
The original design is a free responsive error page built with modern
technologies and latest trends; its skin adapts to any web project, and it
includes social icons plus a way to guide users back to the homepage. Nova
...
### Requirement: Error section with social links
The system SHALL render a centered error section with a large "404" heading, a
"Page not found" subheading, a short explanatory message, a "Back to home"
button that links to the page root, and social icon links.
