...
- **Placeholder images (never copy ColorLib assets):** hero slides → `picsum.photos/seed/palate-hero1/1920/1080`, `palate-hero2`, `palate-hero3` (source `bg_1..3.jpg`); counter bg → `picsum.photos/seed/palate-counter/1920/600` (`bg_4.jpg`); menu items → `picsum.photos/seed/palate-m1/200/200` … `palate-m18` (100px circles, `breakfast-1.jpg` etc.); chefs → `picsum.photos/seed/palate-c1/600/800` … `palate-c4` (`chef-1..4.jpg`); testimony avatars → `picsum.photos/seed/palate-t1/200/200` … `palate-t5` (`person_1..5.jpg`); testimony bg → `picsum.photos/seed/palate-testimonial/1920/800` (`bg_5.jpg`); instagram thumbs → `picsum.photos/seed/palate-i1/300/300` … `palate-i6` (`insta-1..6.jpg`); map → a static muted map placeholder (`picsum.photos/seed/palate-map/800/600` or CSS grid pattern).
...
- [ ] Placeholder images = seeded picsum (`palate-hero1..3`, `palate-counter`, `palate-m1..18`, `palate-c1..4`, `palate-t1..5`, `palate-testimonial`, `palate-i1..6`, `palate-map`); icons from lucide-react (`Phone`, `Send`, `Menu`, `Cake`, `Users`, `UtensilsCrossed`, `Play`, `ChevronDown`, `Quote`, `Heart`) + inline-SVG brand glyphs for Twitter/Facebook/Instagram/Google+ — no copied assets
