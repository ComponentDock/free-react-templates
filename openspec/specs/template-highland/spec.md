...
| Video play button       | white circle (60x60px), border-radius 50%, blue `#009DFF` icon                               | Video section play overlay                                                                                   |
...
- [x] All 10 sections present in correct order
- [x] Brand color #009DFF used consistently (labels, buttons, accents, hover states)
- [x] Raleway font family applied globally
- [x] Navbar is transparent initially, sticky black on scroll
- [x] Hero slider with 4 slides, centered white text
- [x] About section has 2-column layout with overlapping images
- [x] Offers section has 3 cards with images, bullets, and "book now" buttons
- [x] Video section has dark overlay and circular play button
- [x] Dining section has reversed layout (images left, text right)
- [x] Featured Rooms has 4 room cards with gradient overlays
- [x] Reservation bar has bordered box with phone pill button
- [x] Instagram feed shows 5 images with hover overlay
- [x] Footer has 4 columns + newsletter + copyright
...
- [x] public/CNAME contains highland.free.componentdock.com
- [x] package.json homepage set to https://highland.free.componentdock.com
