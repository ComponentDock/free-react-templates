      ...
      {socials.map((social) => (
        <li key={social.name}>
          <a
            ...
            className={
              inverted
                ? 'flex h-9 w-9 items-center justify-center rounded-full bg-gradient-to-r from-aqua via-teal to-sky text-white transition-opacity hover:opacity-90'
                : 'flex h-9 w-9 items-center justify-center rounded-full bg-white text-gray-500 ring-1 ring-gray-200 transition-colors hover:bg-teal hover:text-white dark:bg-gray-800 dark:text-gray-300 dark:ring-gray-700'
            }
          >
