...
export function Footer() {
  return (
    <footer className="bg-brand-footer text-white pt-16 pb-6" role="contentinfo">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          <div>
            ...
            <p className="text-white/60 text-sm leading-relaxed mb-4">
              Professional cleaning services delivering spotless results for homes and businesses.
              Trusted since 2010.
            </p>
          ...
          {/* Latest News */}
          <div>
            <h4 className="font-bold mb-4 text-sm uppercase tracking-wider">Latest News</h4>
            <ul className="space-y-3 text-sm">
              <li>
                <a href="#" className="text-white/60 hover:text-white transition-colors">
                  Benefits of Professional Office Cleaning
                </a>
                <span className="block text-white/40 text-xs mt-0.5">Aug 10, 2026</span>
              </li>
              <li>
                <a href="#" className="text-white/60 hover:text-white transition-colors">
                  How to Maintain a Clean Kitchen
                </a>
                <span className="block text-white/40 text-xs mt-0.5">Jul 25, 2026</span>
              </li>
            </ul>
          </div>
          ...
          {/* Contact Info */}
          <div>
            <h4 className="font-bold mb-4 text-sm uppercase tracking-wider">Have a Question?</h4>
