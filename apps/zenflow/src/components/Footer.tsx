export function Footer() {
  const socialLinks = [
    ...
    {
      label: 'Pinterest',
      path: 'M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-1.1 0-2.15-.23-3.1-.63l-.23-.14c-.57-.35-1.18-.82-1.73-1.36-.55-.54-1.02-1.15-1.36-1.73l-.14-.23C5.23 14.15 5 13.1 5 12c0-3.87 3.13-7 7-7s7 3.13 7 7-3.13 7-7 7z',
    },
    {
      label: 'Dribbble',
    ...
    {
      label: 'YouTube',
      path: 'M22.54 6.42a2.78 2.78 0 0 0-1.94-2C18.88 4 12 4 12 4s-6.88 0-8.6.46a2.78 2.78 0 0 0-1.94 2A29 29 0 0 0 1 11.75a29 29 0 0 0 .46 5.33A2.78 2.78 0 0 0 3.4 19.1c1.72.46 8.6.46 8.6.46s6.88 0 8.6-.46a2.78 2.78 0 0 0 1.94-2 29 29 0 0 0 .46-5.25 29 29 0 0 0-.46-5.33z',
    },
    {
      label: 'Instagram',
          ...
          <div className="flex gap-4">
            {socialLinks.map((social) => (
              <a
                ...
                className="flex h-10 w-10 items-center justify-center text-gray-400 transition-colors hover:text-primary-400"
              >
      ...
      <div className="border-t border-gray-700">
        <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-4 px-4 py-6 sm:flex-row sm:px-6">
          <p className="text-sm text-gray-400">
            &copy; {new Date().getFullYear()} Zenflow. All rights reserved. Made with{' '}
            <a
