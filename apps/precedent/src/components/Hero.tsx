...
export function Hero() {
  return (
    ...
    >
      {/* Background image */}
      <img
        src="https://picsum.photos/seed/precedent-hero/1920/1080"
        alt=""
      ...
      <div className="relative z-10 mx-auto max-w-3xl px-4 text-center sm:px-6">
        <h1
          id="hero-heading"
          className="font-heading mb-6 text-3xl font-bold leading-tight text-white sm:text-4xl lg:text-5xl"
        >
        ...
        <div className="flex flex-wrap items-center justify-center gap-4">
          <a
            href="#contact"
            className={cn(
              'inline-block rounded bg-[#c5a55a] px-8 py-3 text-sm font-semibold text-white',
              'transition-colors hover:bg-[#b8963e]',
            )}
          >
            Contact us
          </a>
          <a
            ...
            className={cn(
              ...
              'transition-colors hover:bg-white hover:text-[#333333]',
            )}
          >
            Read more
          </a>
