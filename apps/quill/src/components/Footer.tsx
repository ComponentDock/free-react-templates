...
const services = ['Experience', 'Marketing Goals', 'Targeting Vision']
        ...
        <div className="grid gap-12 sm:grid-cols-2 lg:grid-cols-4">
          <div>
            ...
            <p className="mt-4 text-sm leading-relaxed text-white/60">
              Independent author sharing stories that inspire, challenge, and connect readers across
              the world.
            </p>
          ...
          <div>
            <h3 className="font-display text-lg font-bold">Have a Question?</h3>
