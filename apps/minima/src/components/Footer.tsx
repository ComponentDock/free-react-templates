...
const footerLinks = [
  {
    title: 'Community',
    links: ['Projects', 'Team', 'Reviews', 'FAQs'],
  },
  {
    title: 'About Us',
    links: ['Our Story', 'Meet the team', 'Careers'],
  },
  {
    title: 'Company',
      ...
      <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-5">
          ...
          {footerLinks.map((group) => (
            <div key={group.title}>
              <h4 className="mb-4 text-sm font-bold uppercase tracking-wider">{group.title}</h4>
