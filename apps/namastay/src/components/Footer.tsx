    ...
    <footer className="bg-ink text-white" role="contentinfo">
      <div className="mx-auto max-w-7xl px-4 py-12">
        <div className="grid gap-8 md:grid-cols-3">
          {/* About */}
          <div>
            <h3 className="font-display mb-4 text-lg font-bold">About Namastay</h3>
            <p className="mb-4 text-sm text-white/60">
              Your journey to wellness starts here. We offer authentic yoga classes for all levels
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-white/60">
              <li>
                <span className="block text-white/80">Address:</span>
                34 Street Name, City Name Here, United States
              </li>
              <li>
                <span className="block text-white/80">Telephone:</span>
                +1 242 4942 290
              </li>
              <li>
      ...
      {/* Bottom bar with Component Dock attribution */}
      <div className="border-t border-white/10 py-4">
        <div className="mx-auto max-w-7xl px-4 text-center text-sm text-white/40">
          &copy; {new Date().getFullYear()} Namastay. More templates at{' '}
          <a
