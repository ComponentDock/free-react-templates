...
export default function TopBar() {
  return (
    <div className="hidden md:flex bg-gradient-to-r from-brand-accent to-brand-gradient-end text-white text-sm py-2">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between w-full">
        ...
        <div className="flex items-center gap-6">
          ...
          <a href="#appointment" className="hover:opacity-80 transition-opacity">
            Appointment
          </a>
