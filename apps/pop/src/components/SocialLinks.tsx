      ...
      {socials.map((social) => (
        <li key={social.name}>
          <a
            ...
            className="flex h-10 w-10 items-center justify-center rounded-full border border-gray-200 bg-white text-brand transition-colors hover:bg-brand hover:text-white dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 dark:hover:bg-brand dark:hover:text-white"
          >
