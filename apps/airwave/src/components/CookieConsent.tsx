...
const COOKIE_KEY = 'airwave-cookie-consent'
    ...
    >
      ...
      <div className="mt-4 flex items-center justify-end gap-3">
        <button
          ...
          className="rounded-full border border-gray-700 px-5 py-2 text-sm font-semibold text-gray-300 transition-colors hover:bg-gray-800"
        >
          Decline
        </button>
        <button
          ...
          className="rounded-full bg-primary-600 px-5 py-2 text-sm font-semibold text-white transition-colors hover:bg-primary-500"
        >
          Accept All
        </button>
      </div>
