...
export function Navbar() {
  ...
  return (
    <header className="sticky top-0 z-50 bg-nav shadow-sm">
              ...
              <li key={link.label}>
                <a
                  ...
                  className={cn(
                    ...
                    link.active ? 'font-semibold text-brand' : 'text-white/70 hover:text-brand',
                  )}
                >
                  {link.label}
                </a>
      ...
      <div
        className={cn(
          'overflow-hidden bg-nav transition-all duration-300 lg:hidden',
            ...
            {navLinks.map((link) => (
              <li key={link.label}>
                <a
                  ...
                  className="block py-2.5 text-sm font-medium text-white transition-colors hover:text-brand focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand"
                >
                  {link.label}
                </a>
              </li>
