...
const instagramImages = Array.from(
  { length: 8 },
  (_, i) => `https://picsum.photos/seed/strider-ig${i}/100/100`,
)
...
export function Footer() {
  return (
    <footer className="bg-footer-bg py-12 text-gray-400">
      <div className="mx-auto grid max-w-7xl grid-cols-2 gap-8 px-4 md:grid-cols-4 lg:px-8">
        ...
        <div>
          ...
          <p className="text-xs leading-relaxed">
            We are passionate about bringing you the latest trends in fashion. Premium quality
            sneakers, sportswear, and accessories for every occasion.
          </p>
        </div>
        ...
        <div>
          ...
          <p className="mb-3 text-xs">Stay updated with our latest arrivals.</p>
          <form className="flex" onSubmit={(e) => e.preventDefault()}>
            <input
              type="email"
              placeholder="Enter Email"
              className="flex-1 rounded-l-full bg-white/10 px-4 py-2 text-xs text-white placeholder-gray-500 outline-none"
              aria-label="Email for newsletter"
            />
            <button
              type="submit"
              aria-label="Subscribe"
              className="rounded-r-full bg-gradient-to-r from-brand-light to-brand px-4 py-2 text-white transition-opacity hover:opacity-90"
            >
              <Send size={14} />
            </button>
          </form>
        ...
        <div>
          ...
          <p className="mb-3 text-xs">Let us be social</p>
