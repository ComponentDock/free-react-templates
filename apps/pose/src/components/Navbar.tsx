  ...
  return (
    <header className="sticky top-0 z-50 bg-ink shadow-md">
      <div className="relative mx-auto flex h-20 max-w-7xl items-center justify-between px-4 lg:px-8">
        <a href="#home" className="flex items-center gap-2.5" aria-label="Pose">
          ...
          <span className="leading-tight">
            ...
            <span className="block text-[10px] font-semibold uppercase tracking-[0.3em] text-brand">
              MODEL AGENCY
            </span>
          </span>
        </a>
