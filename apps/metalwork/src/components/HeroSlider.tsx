 ...
 *  background photo, dark top gradient, circular play button, uppercase
 *  headline wrapped in an orange highlight block, subtext, and prev/next +
 *  dot navigation. */
        ...
        >
          ...
          <div className="relative z-10 flex h-full items-center justify-center">
            <div className="mx-auto max-w-3xl px-4 text-center">
              ...
              <h1 className="mt-4 font-heading text-4xl leading-tight font-light text-white uppercase md:text-[50px]">
                <span className="bg-primary-600 px-[0.3em] text-white shadow-[0.5em_0_0_#fd5f00,-0.5em_0_0_#fd5f00] box-decoration-clone">
                  {slide.headline}
                </span>
              </h1>
