...
const quickLinks = ['Home', 'Listings', 'Pages', 'Blog', 'Contact']
    ...
    <footer className="bg-dark-bg text-white">
      <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6">
        <div className="grid gap-12 md:grid-cols-3">
          {/* Logo & info */}
          <div>
            <span className="mb-4 block text-2xl font-bold">Dirly</span>
            <p className="mb-6 text-sm leading-relaxed text-gray-300">
              Discover the best local attractions, restaurants, and hidden gems in your city. Your
              go-to directory for everything nearby.
            </p>
            <div className="space-y-3 text-sm text-gray-300">
              <div className="flex items-center gap-2">
                <MapPin className="h-4 w-4 text-brand" />
                <span>123 Discovery Lane, City Center</span>
              </div>
              <div className="flex items-center gap-2">
      ...
      <div className="border-t border-white/10">
        <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-2 px-4 py-4 sm:flex-row sm:px-6">
          <p className="text-xs text-gray-400">
            &copy; {new Date().getFullYear()} Dirly. All rights reserved.
          </p>
          <p className="text-xs text-gray-400">
            More templates at{' '}
            <a
