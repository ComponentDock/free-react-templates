...
const features: Feature[] = [
  ...
  },
  {
    ...
    copy: 'Regular security patches and feature releases keep your app cutting edge.',
  },
  {
    icon: Cloud,
    title: 'Cloud Backup',
    copy: 'Automatic cloud backups ensure your data is always safe and recoverable.',
  },
  {
    icon: BarChart3,
    title: 'Smart Analytics',
    copy: 'Actionable insights with real-time dashboards to track user engagement.',
  },
] as const
