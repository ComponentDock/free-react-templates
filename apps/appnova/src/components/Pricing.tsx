...
const plans = [
  { name: 'Basic', audience: 'For individuals', price: '$9' },
  { name: 'Standard', audience: 'For small teams', price: '$29' },
  { name: 'Premium', audience: 'For enterprises', price: '$49' },
] as const
          ...
          {plans.map((plan) => (
            ...
            >
              ...
              <div className="px-10 py-10">
                ...
                <ButtonLink
                  href="#pricing"
                  className="mt-8 w-full rounded-full border border-gray-300 bg-paper px-10 py-4 text-sm font-medium uppercase tracking-wide text-ink hover:border-transparent hover:bg-gradient-to-r hover:from-purple-500 hover:to-purple-400 hover:text-white dark:border-gray-700 dark:bg-gray-800 dark:text-gray-200"
                >
                  Get Started
                </ButtonLink>
              </div>
