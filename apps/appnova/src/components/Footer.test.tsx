...
describe('Footer', () => {
  it('renders the link columns, newsletter signup, social links, and copyright bar', () => {
    ...
    expect(
      screen.getByText(`Copyright © ${new Date().getFullYear()} Appnova. All rights reserved.`),
    ).toBeInTheDocument()
  ...
  it('subscribes with the newsletter form and clears the input', async () => {
    ...
    await user.type(input, 'hello@appnova.com')
    expect(input).toHaveValue('hello@appnova.com')
