      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-4 leading-relaxed text-muted dark:text-gray-400">
            A look inside Appnova — clean screens designed to keep every task one tap away.
          </p>
        </div>
        ...
        <div className="mt-14 grid grid-cols-2 gap-6 lg:grid-cols-4">
          {screens.map((screen) => (
            <img
              key={screen}
              src={`https://picsum.photos/seed/appnova-screen-${screen}/400/800`}
              alt={`Appnova screen ${screen}`}
