    ...
    <header className="fixed top-0 z-50 w-full bg-gray-900">
      <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-4 sm:px-6">
        ...
        <nav aria-label="Primary" className="hidden items-center gap-6 md:flex">
          ...
          <a
            href="#register"
            className="rounded bg-fest-400 px-5 py-2 text-sm font-semibold text-white transition-colors hover:bg-fest-500"
          >
            Buy Ticket
          </a>
        </nav>
        ...
        <ul className="space-y-1 px-4 pb-4">
          ...
          <li>
            <a
              href="#register"
              onClick={() => setOpen(false)}
              className="mt-2 block rounded bg-fest-400 px-5 py-2 text-center text-sm font-semibold text-white hover:bg-fest-500"
            >
              Buy Ticket
            </a>
          </li>
