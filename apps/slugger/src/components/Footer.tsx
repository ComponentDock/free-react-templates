...
import { contact, footerAbout, footerColumns } from '../data'
...
export function Footer() {
  ...
  return (
    <footer id="contact" className="bg-night pb-8 pt-16 text-white/60">
      <div className="mx-auto grid max-w-7xl gap-10 px-4 sm:grid-cols-2 sm:px-6 lg:grid-cols-5 lg:px-8">
        <div>
      ...
      <div className="mx-auto mt-12 max-w-7xl border-t border-white/10 px-4 pt-6 text-center text-sm sm:px-6 lg:px-8">
        <p>
