...
const offers = [
  { label: 'Listed Properties', href: '#services' },
  ...
  return (
    <footer id="contact" className="bg-navy text-white">
      <div className="mx-auto grid max-w-6xl gap-10 px-4 py-14 sm:grid-cols-2 sm:px-6 lg:grid-cols-4">
        ...
        <div>
          ...
          <p className="mt-4 text-sm leading-relaxed text-gray-400">
            Havenridge is your trusted partner in finding the perfect property. With decades of
            experience, we deliver exceptional real estate services.
          </p>
          <div className="mt-6 flex gap-4">
            <a
              href="https://twitter.com"
              aria-label="Twitter"
              className="flex h-9 w-9 items-center justify-center rounded-full border border-gray-600 text-gray-400 transition-colors hover:border-primary-500 hover:text-primary-500"
            >
        ...
        {/* Offers */}
        <div>
          <h3 className="mb-4 text-sm font-semibold uppercase tracking-wider">Offers</h3>
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm text-gray-400">
            ...
            <li className="flex items-center gap-2">
              ...
              <a
                href="mailto:info@havenridge.com"
      ...
      <div className="border-t border-gray-700 py-6 text-center text-sm text-gray-400">
        <p>
          &copy; {new Date().getFullYear()} Havenridge. All rights reserved. Built with{' '}
          <a
