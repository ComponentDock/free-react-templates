...
describe('App', () => {
  it('sets the document title', () => {
    render(<App />)
    expect(document.title).toBe('Stayly — Booking Form Template')
  })

  it('renders the full-viewport booking section with the centered split card', () => {
    ...
    expect(section.className).toMatch(/bg-mist/)
    ...
    expect(card.className).toMatch(/shadow-\[0_5px_10px_-5px_rgba\(0,0,0,0\.3\)\]/)
