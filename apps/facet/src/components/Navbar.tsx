    ...
    <header className="absolute inset-x-0 top-0 z-50">
      <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-5 sm:px-6">
        ...
        <div className="flex items-center gap-3">
          <a
            href="#contact"
            className="hidden rounded bg-brand px-4 py-2 text-sm font-medium text-white transition-colors hover:bg-brand-dark lg:inline-flex"
          >
            Request a quote
          </a>
        ...
        <div className="fixed inset-0 z-50 flex flex-col bg-white lg:hidden dark:bg-gray-950">
          ...
          <nav id="mobile-menu" aria-label="Mobile menu" className="flex flex-col gap-2 px-6 py-4">
            ...
            <a
              href="#contact"
              onClick={() => setOpen(false)}
              className="mt-2 rounded-lg bg-brand px-4 py-3 text-center text-base font-medium text-white"
            >
              Request a quote
            </a>
          </nav>
