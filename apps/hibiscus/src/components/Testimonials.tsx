...
const testimonials = [
  {
    ...
    image: 'https://picsum.photos/seed/hibiscus-john/100/100',
  },
  {
    name: 'Sarah Williams',
    title: 'Holiday Maker',
    ...
    image: 'https://picsum.photos/seed/hibiscus-sarah/100/100',
  },
  {
    name: 'Michael Brown',
    title: 'Wedding Guest',
    quote:
      'I attended a wedding at Hibiscus and the venue, service, and attention to detail were simply world-class.',
    image: 'https://picsum.photos/seed/hibiscus-michael/100/100',
  },
  {
    name: 'Emily Davis',
    title: 'Travel Blogger',
    quote:
      'As a travel blogger, I have stayed at many hotels. Hibiscus stands out with its unique charm and outstanding hospitality.',
    image: 'https://picsum.photos/seed/hibiscus-emily/100/100',
  },
]
      ...
      <div className="mx-auto max-w-7xl px-4">
        ...
        <div className="relative mx-auto max-w-2xl">
          ...
          <div className="text-center">
            ...
            <p className="text-sm text-mist">{t.title}</p>
          </div>
