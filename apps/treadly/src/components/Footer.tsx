...
const shopLinks = ['Running', 'Sneakers', 'Basketball', 'Casual', 'Boots', 'Sandals'] as const
const helpLinks = ['FAQ', 'Shipping & Returns', 'Size Guide', 'Contact Us', 'Track Order'] as const
const aboutLinks = ['Our Story', 'Sustainability', 'Athletes', 'Careers', 'Store Locator'] as const
    ...
    <footer className="bg-gray-950 pt-16 text-gray-300 lg:pt-24">
      <div className="mx-auto max-w-7xl px-4 lg:px-8">
        ...
        <div className="mt-12 flex flex-col items-center justify-between gap-4 border-t border-gray-800 py-6 sm:flex-row">
          <p className="text-sm text-gray-500">© 2026 Treadly. All rights reserved.</p>
