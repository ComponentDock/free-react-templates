const DOCTORS = [
  {
    ...
    image: 'https://picsum.photos/seed/medprime-doc1/400/400',
  },
  {
    name: 'Dr. James Cooper',
    specialty: 'Neurologist',
    image: 'https://picsum.photos/seed/medprime-doc2/400/400',
  },
  {
    name: 'Dr. Emily Chen',
    specialty: 'Ophthalmologist',
    image: 'https://picsum.photos/seed/medprime-doc3/400/400',
  },
]
          ...
          {DOCTORS.map((doc) => (
            ...
            >
              ...
              <div className="p-6 text-center">
                ...
                <p className="text-brand-primary text-sm mt-1">{doc.specialty}</p>
              </div>
            </div>
          ))}
        </div>
