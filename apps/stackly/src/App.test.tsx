...
describe('App', () => {
  it('renders the heading "Accordion #08"', () => {
    render(<App />)
    expect(screen.getByRole('heading', { name: /accordion #08/i })).toBeInTheDocument()
  })
  ...
  it('sets the document title', () => {
    render(<App />)
    expect(document.title).toBe('Stackly — FAQ Accordion Template')
  })
})
