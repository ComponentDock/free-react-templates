    ...
    <footer className="border-t border-gray-200 bg-white py-10 dark:border-gray-800 dark:bg-gray-900">
      <div className="mx-auto flex max-w-6xl flex-col items-center gap-4 px-4 sm:flex-row sm:justify-between sm:px-6">
        <div className="text-center sm:text-left">
          <p className="font-bold text-black dark:text-white">ModalPoint</p>
          <p className="text-sm text-gray-500 dark:text-gray-400">
            A registration modal for your next project.
          </p>
        </div>
        <a
...
// Re-export countries so footer test can import if needed
export { COUNTRIES }
