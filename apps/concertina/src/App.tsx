...
export function App() {
  useEffect(() => {
    document.title = 'Concertina — Interactive Accordion Template'
  }, [])
    ...
    <div className="flex min-h-screen flex-col bg-page font-sans text-text-header">
      <main className="flex flex-1 items-center justify-center px-4 py-16">
        <div className="w-full max-w-[700px]">
          <h1 className="mb-8 text-center font-heading text-2xl font-semibold text-text-header">
            Bootstrap Accordion #6
          </h1>
