...
export function Testimonials() {
  return (
    <section id="testimonial" className="relative overflow-hidden py-20 lg:py-[120px]">
      <img
        src="https://picsum.photos/seed/taper-testimonial/1920/900"
        alt=""
      ...
      <div className="relative z-10 mx-auto max-w-3xl px-4 text-center sm:px-6">
        ...
        <blockquote className="mt-6 font-display text-xl leading-relaxed text-white sm:text-2xl">
          Fantastic barbershop! I have been coming here for years and every cut leaves me looking
          sharp. The team knows exactly what suits you and the atmosphere is always welcoming.
        </blockquote>
