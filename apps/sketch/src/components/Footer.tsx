...
const navColumns = [
  ...
  {
    title: 'Legal',
    links: ['Privacy', 'FAQ', 'Careers', 'Terms', 'About Us'],
  },
]

export function Footer() {
  return (
    <footer id="about" className="bg-heading py-16 text-white">
      <div className="mx-auto max-w-7xl px-6">
        <div className="grid gap-12 lg:grid-cols-5">
          ...
          <div className="lg:col-span-3">
            <h3 className="mb-6 text-lg font-bold">Navigations</h3>
        ...
        <div className="mt-12 border-t border-gray-700 pt-8 text-center">
          <p className="text-sm text-gray-400">
            &copy; {new Date().getFullYear()} Sketch. All rights reserved. Made with{' '}
            <a
              href="https://www.componentdock.com/"
              className="text-white underline hover:text-brand"
            >
              Component Dock
            </a>
          </p>
