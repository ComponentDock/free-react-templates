const columns = [
  {
    ...
    links: ['Web Design', 'Graphic Design', 'Web Developers', 'Python', 'HTML5', 'CSS3'],
  },
  {
    title: 'Company',
            ...
            <div className="flex gap-3">
              {socials.map((social) => (
                <a
                  ...
                  className="flex h-9 w-9 items-center justify-center rounded-full bg-white/10 text-gray-400 transition-colors hover:bg-white/20 hover:text-white"
                >
                  {social.svg}
                </a>
              ))}
