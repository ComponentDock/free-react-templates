...
const coaches = [
  { name: 'Travor James', role: 'Head Coach', img: 'ironpulse-coach1' },
  { name: 'Leonard Smith', role: 'Lead Trainer', img: 'ironpulse-coach2' },
  { name: 'James Buffer', role: 'Trainer', img: 'ironpulse-coach3' },
  { name: 'Maricar Collins', role: 'Trainer', img: 'ironpulse-coach4' },
]
