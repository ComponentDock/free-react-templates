...
export function Testimonials() {
  return (
    <section className="relative bg-dark py-20">
      <img
        src="https://picsum.photos/seed/ironpulse-test-bg/1920/600"
        alt=""
