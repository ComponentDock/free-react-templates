...
const platforms = [
  ...
  },
  {
    ...
    outline: 'border-linkedin text-linkedin',
  },
  {
    name: 'Pinterest',
    Icon: PinterestIcon,
    solid: 'bg-pinterest text-white',
    outline: 'border-pinterest text-pinterest',
  },
  {
    name: 'Dribbble',
    Icon: DribbbleIcon,
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <div className="flex flex-wrap gap-2">
        {platforms.map((p) => (
          <button
            key={`si-solid-${p.name}`}
            type="button"
            className={`${p.solid} shadow-[3px_5px_0_0_rgba(0,0,0,0.15)] inline-flex h-10 w-10 items-center justify-center rounded transition-all hover:-translate-y-0.5`}
          >
            <p.Icon />
          </button>
        ))}
      ...
      <div className="flex flex-wrap gap-2">
        {platforms.map((p) => (
          <button
            key={`si-rsolid-${p.name}`}
            type="button"
            className={`${p.solid} shadow-[3px_5px_0_0_rgba(0,0,0,0.15)] inline-flex h-10 w-10 items-center justify-center rounded-full transition-all hover:-translate-y-0.5`}
          >
            <p.Icon />
          </button>
        ))}
      ...
      <div className="flex flex-wrap gap-2">
        {platforms.map((p) => (
          <button
            key={`si-outline-${p.name}`}
            type="button"
            className={`${p.outline} border bg-white shadow-[3px_5px_0_0_rgba(0,0,0,0.1)] inline-flex h-10 w-10 items-center justify-center rounded transition-all hover:-translate-y-0.5`}
          >
            <p.Icon />
          </button>
        ))}
      ...
      <div className="flex flex-wrap gap-2">
        {platforms.map((p) => (
          <button
            key={`si-routline-${p.name}`}
            type="button"
            className={`${p.outline} border bg-white shadow-[3px_5px_0_0_rgba(0,0,0,0.1)] inline-flex h-10 w-10 items-center justify-center rounded-full transition-all hover:-translate-y-0.5`}
          >
            <p.Icon />
          </button>
        ))}
