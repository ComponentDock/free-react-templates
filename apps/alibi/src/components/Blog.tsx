...
const posts = [
  {
    image: 'https://picsum.photos/seed/alibi-blog-1/600/400',
    alt: 'Legal advice article',
    date: 'March 15, 2024',
  ...
  {
    image: 'https://picsum.photos/seed/alibi-blog-2/600/400',
  ...
  {
    image: 'https://picsum.photos/seed/alibi-blog-3/600/400',
    alt: 'Criminal defense article',
    date: 'March 5, 2024',
    title: 'Essential Steps for Effective Criminal Defense',
    excerpt:
      'Being accused of a crime is stressful. Here is what you need to know about building a strong defense strategy.',
  },
]
    ...
    <section id="blog" className="py-20">
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="text-center">
          <h2 className="text-3xl font-bold text-ink sm:text-4xl">Latest From Blog</h2>
        </div>
          ...
          {posts.map((post) => (
            ...
            >
              ...
              <div className="p-6">
                ...
                <h3 className="mt-4 text-lg font-bold text-ink">{post.title}</h3>
