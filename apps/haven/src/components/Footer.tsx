    ...
    <footer id="contact" className="bg-ink text-gray-400">
      <div className="mx-auto grid max-w-7xl gap-10 px-4 py-14 sm:grid-cols-2 sm:px-6 lg:grid-cols-3">
        ...
        <div>
          ...
          <ul className="mt-5 space-y-3 text-sm">
            ...
            <li className="flex items-center gap-2">
              ...
              <a href="mailto:info@haven.com" className="transition-colors hover:text-primary-400">
                info@haven.com
              </a>
            </li>
            <li className="flex items-start gap-2">
        ...
        <div>
          ...
          <p className="mt-5 text-sm leading-relaxed">Get the latest updates and offers.</p>
