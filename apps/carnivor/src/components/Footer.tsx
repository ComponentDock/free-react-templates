...
const quickLinks = ['Home', 'About', 'Menu', 'Chefs', 'Contact'] as const
  ...
  return (
    <footer className="bg-ink text-white transition-colors dark:bg-gray-900">
        ...
        <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-4">
          <div>
            ...
            <p className="mt-5 text-sm leading-relaxed text-gray-400">
              ...
              chefs. Every bite tells a story of craftsmanship.
            </p>
          ...
          <div>
            ...
            <ul className="mt-5 space-y-3 text-sm text-gray-400">
              <li>123 Grill Avenue, Foodville, FC 12345</li>
              <li>+1 234 567 890</li>
              <li>info@carnivor.com</li>
            </ul>
          </div>

          <div>
            <h3 className="text-lg font-bold uppercase tracking-wide text-brand">Newsletter</h3>
            <p className="mt-5 text-sm text-gray-400">Stay updated with our latest offers.</p>
            {subscribed ? (
      ...
      <div className="border-t border-gray-700 py-5 text-center text-sm text-gray-500">
        © {new Date().getFullYear()} Carnivor. Made with{' '}
        <a
