...
describe('Header', () => {
  it('renders the tagline, logo, and phone number', () => {
    render(<Header />)
  ...
  it('renders navigation links in the nav element', () => {
    ...
    expect(linkTexts).toContain('We Offer')
    expect(linkTexts).toContain('Top Course')
    expect(linkTexts).toContain('Schedule')
    expect(linkTexts).toContain('Trainer')
    expect(linkTexts).toContain('Plan')
  })
