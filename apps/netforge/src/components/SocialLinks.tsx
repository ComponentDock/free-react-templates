      ...
      {socials.map((social) => (
        <li key={social.name}>
          <a
            ...
            className="flex h-9 w-9 items-center justify-center rounded-full bg-gray-800 text-gray-300 ring-1 ring-gray-700 transition-colors hover:bg-primary-500 hover:text-white"
          >
