...
const quickLinks = ['About Us', 'Testimonials', 'Terms of Service', 'Privacy'] as const
const resources = ['About Us', 'Testimonials', 'Terms of Service', 'Privacy'] as const
const support = ['About Us', 'Testimonials', 'Terms of Service', 'Privacy'] as const
const company = ['About Us', 'Testimonials', 'Terms of Service', 'Privacy'] as const
...
const socials = [
  { label: 'Facebook', icon: brandPaths.facebook },
  { label: 'Instagram', icon: brandPaths.instagram },
  { label: 'Twitter', icon: brandPaths.twitter },
  { label: 'LinkedIn', icon: brandPaths.linkedin },
] as const
  ...
  return (
    <footer id="contact" className="bg-coal text-white">
      ...
      <div className="border-t border-white/10 py-5 text-center text-sm text-white/50">
        Copyright © {new Date().getFullYear()} All rights reserved | DriveGo — More templates at{' '}
        <a
