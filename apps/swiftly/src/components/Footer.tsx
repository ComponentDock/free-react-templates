const navColumns = [
  { title: 'Services', links: ['Home', 'Services', 'Work', 'Process', 'About Us'] },
  { title: 'Company', links: ['Press', 'Blog', 'Contact', 'Support', 'Privacy'] },
  { title: 'Support', links: ['Privacy', 'FAQ', 'Careers', 'Process', 'About Us'] },
]
...
export function Footer() {
  return (
    <footer className="bg-[#1a1a2e] py-16 text-white">
      <div className="mx-auto max-w-6xl px-6">
        <div className="grid gap-10 lg:grid-cols-[1fr_2fr]">
          ...
          <div className="grid grid-cols-2 gap-8 sm:grid-cols-3">
            {navColumns.map((col) => (
              <div key={col.title}>
                <h3 className="mb-3 text-lg font-bold">{col.title}</h3>
