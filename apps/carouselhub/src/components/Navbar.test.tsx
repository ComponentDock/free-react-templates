...
describe('Navbar', () => {
  ...
  it('renders the site name "CarouselHub"', () => {
    render(<Navbar />)
  ...
  it('renders desktop navigation links', () => {
    ...
    expect(screen.getAllByRole('link', { name: 'Gallery' }).length).toBeGreaterThanOrEqual(1)
  ...
  it('closes mobile menu when Gallery link is clicked', () => {
    render(<Navbar />)
    fireEvent.click(screen.getByRole('button', { name: /open menu/i }))
