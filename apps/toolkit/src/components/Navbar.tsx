...
const categories = ['Buttons', 'Forms', 'Cards', 'Alerts', 'Modals', 'Tables']
...
export function Navbar() {
  ...
  return (
    <nav className="fixed top-0 left-0 z-50 flex w-full items-center justify-between bg-transparent px-6 py-4 text-white lg:px-12">
      ...
      <div className="flex items-center gap-6">
        <div ref={ref} className="relative">
          ...
          {open && (
            <menu className="absolute right-0 top-full mt-2 w-48 rounded-md bg-white py-2 shadow-lg">
              {categories.map((cat) => (
                <li key={cat}>
                  <a
