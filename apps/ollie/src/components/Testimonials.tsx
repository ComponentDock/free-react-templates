...
const testimonials: Testimonial[] = [
  {
    quote:
      'Ollie transformed my skating completely. The coaching is world-class and the community keeps me motivated every single day.',
    photo: 'https://picsum.photos/seed/ollie-11/200/200',
    name: 'Tyler Brooks',
    role: 'Street Skater',
  },
  {
    ...
    photo: 'https://picsum.photos/seed/ollie-12/200/200',
    name: 'Emma Walsh',
    role: 'Park Skater',
  },
  {
    ...
    photo: 'https://picsum.photos/seed/ollie-13/200/200',
    name: 'Derek Simmons',
    role: 'Vert Skater',
  },
  {
    ...
    photo: 'https://picsum.photos/seed/ollie-14/200/200',
    name: 'Lisa Tanaka',
