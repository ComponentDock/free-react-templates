...
describe('App', () => {
  it('composes all sections with correct landmarks and title', () => {
    ...
    // Navbar — Ollie link appears in navbar and footer, use getAllByRole
    const ollieLinks = screen.getAllByRole('link', { name: 'Ollie' })
    expect(ollieLinks.length).toBeGreaterThanOrEqual(1)
