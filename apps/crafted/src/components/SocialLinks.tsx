      ...
      {socials.map((social) => (
        <li key={social.name}>
          <a
            ...
            className={
              inverted
                ? 'flex h-9 w-9 items-center justify-center rounded bg-white/10 text-gray-300 transition-colors hover:bg-gradient-to-r hover:from-primary-500 hover:to-primary-300 hover:text-white'
                : 'flex h-9 w-9 items-center justify-center rounded bg-gray-100 text-gray-500 transition-colors hover:bg-primary-500 hover:text-white dark:bg-gray-800 dark:text-gray-300'
            }
          >
