...
function BrandIcon({ name, className = 'h-4 w-4' }: { name: BrandName; className?: string }) {
  return (
...
export function TopHeader() {
  return (
    <div className="bg-heading text-sm text-white/70">
      <div className="mx-auto flex max-w-6xl items-center justify-between px-8 py-2">
        <div className="flex items-center gap-6">
          <a href="#" className="flex items-center gap-2 hover:text-brand">
            ...
            <span>info@componentdock.com</span>
          </a>
          <a href="#" className="flex items-center gap-2 hover:text-brand">
