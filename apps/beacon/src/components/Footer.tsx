export function Footer() {
  return (
    <footer className="bg-beacon-dark-bg py-16 text-center text-white">
      <div className="mx-auto max-w-4xl px-4">
        <h2 className="mb-4 text-3xl font-bold">Let's work together!</h2>
        <p className="mb-8 text-white/70">office@template.com</p>
        ...
        <p className="text-sm text-white/50">
          ...
          <a
            ...
            className="text-beacon-accent transition-colors hover:underline"
            target="_blank"
