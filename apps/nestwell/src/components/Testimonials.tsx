...
const TESTIMONIALS = [
  {
    ...
    avatar: 'https://picsum.photos/seed/nestwell-sarah/100/100',
  },
  {
    name: 'James Cooper',
    role: 'Buyer',
    quote:
      'Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.',
    avatar: 'https://picsum.photos/seed/nestwell-james/100/100',
  },
  {
    name: 'Emily Dawson',
    role: 'Buyer',
    quote:
      'Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.',
    avatar: 'https://picsum.photos/seed/nestwell-emily/100/100',
  },
]
