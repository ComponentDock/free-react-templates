...
export function TopBar() {
  return (
    <div className="relative z-10 bg-transparent text-white border-b border-white/10">
        ...
        <div className="flex items-center">
          {socialLinks.map((link) => (
            <a
              key={link.label}
              href="#"
              className="w-11 h-11 flex items-center justify-center border-l border-white/10 hover:bg-brand hover:border-brand transition-colors"
