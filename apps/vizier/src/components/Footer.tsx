...
export function Footer() {
  return (
    <footer className="bg-heading py-16" data-testid="footer">
      <div className="mx-auto max-w-7xl px-6">
        <div className="grid gap-12 md:grid-cols-3">
          {/* Logo + Description */}
          <div>
            <a href="/" className="mb-4 block text-2xl font-bold text-white">
              Vizier
            </a>
          ...
          {/* Links */}
          <div>
            <h4 className="mb-4 text-lg font-bold text-white">Our Links</h4>
          ...
          <div>
            ...
            <p className="mb-2 text-lg font-bold text-white">+01-3-8888-6868</p>
            <p className="mb-6 text-sm text-gray-400">40 Baria Street 133/2 New York City</p>
