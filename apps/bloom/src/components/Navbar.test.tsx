...
describe('Navbar', () => {
  it('shows the site name, Home link, section links, and a dark-mode toggle', () => {
    render(<Navbar />)

    expect(screen.getByRole('link', { name: /Bloom/ })).toHaveAttribute('href', '#home')
  ...
  it('closes the mobile menu when a link inside it is chosen', async () => {
    ...
    await user.click(within(mobileNav).getByRole('link', { name: 'Work' }))
