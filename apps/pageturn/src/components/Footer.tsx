...
const services = [
  ...
  { label: 'Book Design', href: '#' },
  { label: 'Ghost Writing', href: '#' },
] as const

export function Footer() {
  return (
    <footer className="bg-gray-900 py-16 text-gray-300">
      <div className="mx-auto grid max-w-7xl grid-cols-1 gap-12 px-4 sm:grid-cols-2 lg:grid-cols-4">
        {/* About */}
        <div>
          <h4 className="mb-4 text-lg font-bold text-white">About PageTurn</h4>
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm text-gray-400">
            <li>2820 Maple Avenue, Portland, OR 97201</li>
            <li>+1 (503) 555-0142</li>
            <li>franklin@example.com</li>
          </ul>
        </div>
      </div>
      ...
      <div className="mt-12 border-t border-gray-800 pt-8 text-center">
        <p className="text-sm text-gray-500">
          &copy; {new Date().getFullYear()} PageTurn. All rights reserved. Made with{' '}
          <a
