    ...
    <header className="fixed top-0 left-0 w-full z-50 bg-dark">
      <nav className="flex items-center justify-between px-6 py-4 max-w-7xl mx-auto">
        ...
        <div className="hidden md:flex items-center gap-4">
          <a
            href="#"
            className="bg-brand hover:bg-brand-hover text-white text-sm font-bold px-5 py-2.5 transition-colors"
          >
            Sign Up
          </a>
        </div>
      ...
      {mobileOpen && (
        <div className="md:hidden bg-dark px-6 pb-6">
          ...
          <a
            href="#"
            className="mt-4 block bg-brand text-white text-sm font-bold px-5 py-2.5 text-center"
          >
            Sign Up
          </a>
        </div>
