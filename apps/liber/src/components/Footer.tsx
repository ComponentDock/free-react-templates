...
const quickLinks = ['Home', 'About', 'Features', 'Pricing', 'Courses'] as const
  ...
  return (
    <footer className="bg-ink text-white transition-colors dark:bg-ink-dark">
        ...
        <div className="grid gap-12 md:grid-cols-3">
          ...
          <div>
            ...
            <p className="mt-6 text-sm leading-relaxed text-gray-400">
              Discover new worlds through the pages of our books. We bring you carefully curated
              reads from award-winning authors around the globe.
            </p>
          ...
          <div>
            ...
            <p className="mt-5 text-sm text-gray-400">Stay updated with our latest releases.</p>
            {subscribed ? (
      ...
      <div className="border-t border-gray-700 py-5 text-center text-sm text-gray-500">
        © {new Date().getFullYear()} Liber. Made with{' '}
        <a
