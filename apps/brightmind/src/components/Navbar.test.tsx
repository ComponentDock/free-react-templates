...
describe('Navbar', () => {
  it('renders the logo and desktop links', () => {
    ...
    for (const label of ['Home', 'About', 'Courses', 'Teachers', 'Blog', 'Events', 'Contact']) {
  ...
  it('closes the mobile menu when a mobile link is clicked', async () => {
    ...
    const courseLinks = screen.getAllByRole('link', { name: 'Courses' })
    const mobileLink = courseLinks[courseLinks.length - 1]!
