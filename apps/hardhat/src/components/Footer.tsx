  ...
  return (
    <footer id="contact" className="bg-navy-deep text-white/70">
      <div className="mx-auto grid max-w-6xl gap-10 px-4 py-14 sm:grid-cols-2 sm:px-6 lg:grid-cols-4">
        <div>
          <a href="#home" className="font-display text-2xl font-bold tracking-wider text-white">
            Hardhat
          </a>
        ...
        <div>
          ...
          <ul className="mt-4 space-y-3 text-sm">
            <li className="flex items-start gap-2">
              ...
              <span>123 Street, New York, NY 10001, United States</span>
            </li>
            <li className="flex items-center gap-2">
              <Phone className="h-4 w-4 shrink-0 text-brand" aria-hidden="true" />
              <a href="tel:+12345678901" className="transition-colors hover:text-brand">
                +123 456-7890
              </a>
            </li>
            <li className="flex items-center gap-2">
              <Mail className="h-4 w-4 shrink-0 text-brand" aria-hidden="true" />
              <a href="mailto:info@hardhat.com" className="transition-colors hover:text-brand">
                info@hardhat.com
              </a>
            </li>
          </ul>
        ...
        <div>
          ...
          <form onSubmit={handleSubmit} className="mt-6 flex flex-col gap-3">
            ...
            <input
              ...
              className="w-full min-w-0 rounded border border-white/20 bg-white/5 px-4 py-3 text-sm text-white placeholder:text-white/40 focus:border-brand focus:outline-none focus:ring-2 focus:ring-brand/30"
            />
            <button
              type="submit"
              className="inline-flex items-center justify-center rounded bg-brand px-6 py-3 text-sm font-semibold text-white transition-colors hover:bg-brand-dark"
            >
              Subscribe
            </button>
          </form>
      ...
      <div className="border-t border-white/10 py-6 text-center text-sm">
        <div className="mx-auto mb-4 max-w-6xl px-4 sm:px-6">
          <div className="h-48 rounded bg-white/5" aria-label="Map placeholder" />
        </div>
        <p>
          &copy; {new Date().getFullYear()} Hardhat. All rights reserved. Made with{' '}
          <a
