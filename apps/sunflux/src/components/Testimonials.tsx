...
const testimonials: Testimonial[] = [
  {
    quote:
      'Our electric bill dropped by 80% the first month after activation. The Sunflux team made the whole process effortless from quote to switch-on.',
    name: 'Marcus Webb',
  ...
  {
    quote:
      'Great communication throughout, and the battery backup has already paid for itself during a summer storm. Highly recommend Sunflux.',
    name: 'Jordan Blake',
    role: 'Homeowner in Austin',
  },
] as const
