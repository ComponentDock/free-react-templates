import { Leaf, Phone, TreePine, Wind } from 'lucide-react'
...
export function Hero() {
  return (
    ...
    >
      {/* Floating blurred blobs — soft green tint */}
      <div
        aria-hidden="true"
      ...
      <div className="relative mx-auto grid max-w-7xl items-center gap-12 px-4 lg:grid-cols-2 lg:px-8">
        <Reveal>
          <div>
            ...
            <div className="mt-8 flex items-center gap-6 text-sm font-medium text-gray-500 dark:text-gray-400">
              <span className="flex items-center gap-2">
                <TreePine className="h-4 w-4 text-primary-500" aria-hidden="true" />
                25,000+ Trees Saved
              </span>
              <span className="flex items-center gap-2">
                <Wind className="h-4 w-4 text-primary-500" aria-hidden="true" />
                8,500+ Tons CO2 Offset
              </span>
            </div>
          </div>
        </Reveal>
