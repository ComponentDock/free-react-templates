      ...
      <div className="mx-auto max-w-7xl px-4 lg:px-8">
        <div className="grid gap-12 lg:grid-cols-5">
          <div className="lg:col-span-2">
            <a href="#home" className="flex items-center gap-2" aria-label="Sunflux home">
              <span className="flex h-9 w-9 items-center justify-center rounded-xl bg-primary-600 text-white">
                <SunMedium className="h-5 w-5" aria-hidden="true" />
              </span>
              <span className="text-xl font-extrabold tracking-tight text-white">Sunflux</span>
            </a>
          ...
          <div>
            ...
            <ul className="mt-4 flex flex-col gap-3 text-sm text-gray-400">
              ...
              <li className="flex items-start gap-2.5">
                ...
                <a
                  href="mailto:hello@sunfluxenergy.com"
                  className="transition-colors hover:text-primary-400"
                >
                  hello@sunfluxenergy.com
                </a>
              </li>
            </ul>
          </div>
        ...
        <div className="mt-12 flex flex-col items-center justify-between gap-4 border-t border-gray-800 py-6 sm:flex-row">
          <p className="text-sm text-gray-500">© 2026 Sunflux. All rights reserved.</p>
