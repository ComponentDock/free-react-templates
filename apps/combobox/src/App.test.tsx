...
describe('App', () => {
  it('sets the document title', () => {
    render(<App />)
    expect(document.title).toBe('Combobox — Multiselect Dropdown Template')
  })

  it('renders the heading', () => {
    render(<App />)
    expect(screen.getByRole('heading', { level: 1 })).toHaveTextContent('Select Language')
  })
  ...
  it('renders the page background with correct color', () => {
    ...
    expect(root?.className).toContain('bg-combobox-bg')
  })
})
