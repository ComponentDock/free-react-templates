...
export function LoginCard() {
  ...
  return (
    <div className="flex items-center justify-center px-4 py-20 lg:h-full lg:px-10 lg:py-0">
      <div className="w-full max-w-md rounded bg-[var(--color-card)] p-10 shadow-sm lg:mt-[-300px] lg:p-10 lg:shadow-lg">
        <form onSubmit={handleSubmit} noValidate>
          <h3 className="mb-6 text-lg font-medium text-[var(--color-ink)]">
            Login to <strong>PassCraft</strong>
          </h3>
          ...
          <div className="mb-4">
            ...
            <input
              ...
              className="h-[54px] w-full rounded bg-[var(--color-input)] px-4 text-sm text-[var(--color-ink)] placeholder-[var(--color-placeholder)] outline-none"
            />
          </div>
