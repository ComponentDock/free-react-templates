...
describe('BootstrapCheckbox', () => {
  it('renders with the given label', () => {
    render(<BootstrapCheckbox label="First checkbox" />)
  ...
  it('toggles to checked when clicked', async () => {
    ...
    render(<BootstrapCheckbox label="Second checkbox" />)
  ...
  it('respects defaultChecked prop', () => {
    render(<BootstrapCheckbox label="First checkbox" defaultChecked />)
    expect(screen.getByRole('checkbox', { name: 'First checkbox' })).toBeChecked()
  })

  it('is disabled when disabled prop is true', async () => {
    const user = userEvent.setup()
    render(<BootstrapCheckbox label="Disabled" disabled />)
  ...
  it('shows checked state when disabled and defaultChecked', () => {
    render(<BootstrapCheckbox label="Disabled & checked" defaultChecked disabled />)
