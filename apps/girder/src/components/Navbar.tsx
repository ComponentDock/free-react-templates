  ...
  return (
    <header className="sticky top-0 z-50 border-b border-black/5 bg-white/95 backdrop-blur dark:border-white/10 dark:bg-gray-950/95">
      <div className="mx-auto flex max-w-6xl items-center justify-between gap-4 px-4 py-4 sm:px-6">
        ...
        >
          Girder<span className="text-brand">.</span>
        </a>
        ...
        <div className="flex items-center gap-3">
          <a
            href="tel:+22924392327"
            className="hidden items-center gap-2 text-sm font-semibold text-ink/70 transition-colors hover:text-brand dark:text-white/70 dark:hover:text-brand lg:flex"
          >
            <Phone className="h-4 w-4" aria-hidden="true" />+ 2 292 4392 327
          </a>
