import { Apple, Dumbbell, HandHeart, Heart } from 'lucide-react'
...
/** How It Works — four numbered steps with circular photos, an icon,
    title, blurb, and Learn More link. */
    ...
    <section className="bg-white">
      <div className="mx-auto max-w-7xl px-4 py-24 sm:px-6">
        ...
        <div className="mt-14 grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-4">
          {STEPS.map(({ title, icon, image, blurb }, index) => {
