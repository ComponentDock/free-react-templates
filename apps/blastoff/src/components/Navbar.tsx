...
export function Navbar() {
  ...
  const [dark, setDark] = useState(() => window.localStorage.getItem('blastoff-dark') === '1')
  ...
  useEffect(() => {
    ...
    window.localStorage.setItem('blastoff-dark', dark ? '1' : '0')
    return () => {
    ...
    >
      ...
      >
        ...
        <div className="flex items-center gap-3">
          ...
          <a
            href="#waitlist"
            className="hidden rounded-lg bg-primary-600 px-5 py-2.5 text-sm font-semibold text-white shadow-lg shadow-primary-600/25 transition-colors hover:bg-primary-700 sm:inline-flex"
          >
            Get Early Access
          </a>
      ...
      >
        ...
        <div className="mt-4 flex flex-col gap-3">
          <a
            href="#waitlist"
            onClick={() => setOpen(false)}
            className="rounded-lg bg-primary-600 px-5 py-3 text-center text-sm font-semibold text-white transition-colors hover:bg-primary-700"
          >
            Get Early Access
          </a>
        </div>
