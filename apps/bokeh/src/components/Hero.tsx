export function Hero() {
  return (
    <section
      ...
      style={{ backgroundImage: "url('https://picsum.photos/seed/bokeh-hero/1920/1080')" }}
    >
      ...
      <div className="container relative mx-auto px-4 lg:px-8">
        <div className="max-w-2xl">
          <h1 className="font-heading text-5xl font-bold leading-tight text-white md:text-6xl">
            i am <br />
            <span className="text-brand">Professional</span> <br />
            Photographer
          </h1>
          <p className="mt-4 font-body text-lg text-gray-300">
            Capturing moments that last forever with artistry and precision.
          </p>
          <a
            href="#portfolio"
      ...
      <div className="absolute bottom-8 left-0 right-0">
        <div className="container mx-auto flex items-center gap-6 px-4 lg:px-8">
          <a
            href="#"
