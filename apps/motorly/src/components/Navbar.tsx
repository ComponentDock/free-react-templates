...
export function Navbar() {
  ...
  return (
    <header className="sticky top-0 z-50">
      {/* Top bar — phone, hours, find-us-on-map (from the original dark strip). */}
      <div className="bg-coal text-white">
        <div className="mx-auto flex max-w-6xl items-center justify-between gap-4 px-4 py-2 text-xs sm:px-6">
          <p className="hidden items-center gap-4 sm:flex">
            <span>(+123) 4567-7890-123</span>
            <span className="text-white/70">Mon-Sat: 10:00 - 16:00 / Sunday Close</span>
          </p>
          <a
            href="#contact"
            className="font-semibold uppercase tracking-wide text-brand hover:text-white"
          >
            Find us on map
          </a>
        </div>
      ...
      <div className="border-b border-black/5 bg-white/95 backdrop-blur dark:border-white/10 dark:bg-gray-950/95">
        <div className="mx-auto flex max-w-6xl items-center justify-between gap-4 px-4 py-4 sm:px-6">
          ...
          >
            Motorly<span className="text-brand">.</span>
          </a>
