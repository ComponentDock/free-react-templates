...
export const DARK_KEY = 'cura-dark'
...
export function Navbar() {
  ...
  return (
    <header className="sticky top-0 z-40 w-full border-b border-gray-200 bg-white/90 backdrop-blur-lg transition-all dark:border-gray-800 dark:bg-gray-950/90">
      <nav
        aria-label="Main"
      ...
      >
        ...
        <div className="flex items-center gap-1 sm:gap-2">
          ...
          <ButtonLink
            href="#booking"
            className="hidden bg-primary-600 px-5 py-2.5 shadow-lg shadow-primary-600/25 hover:bg-primary-700 sm:inline-flex"
          >
            Book Appointment
          </ButtonLink>
          <button
      ...
      >
        <div className="flex flex-col gap-4">
          ...
          <ButtonLink
            href="#booking"
            onClick={() => setOpen(false)}
            className="bg-primary-600 px-5 py-2.5 text-center shadow-lg shadow-primary-600/25 hover:bg-primary-700"
          >
            Book Appointment
          </ButtonLink>
        </div>
