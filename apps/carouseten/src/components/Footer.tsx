    ...
    <footer className="border-t border-brand/20 bg-white py-12 dark:border-gray-800 dark:bg-gray-900">
      <div className="mx-auto flex max-w-6xl flex-col items-center gap-4 px-4 sm:flex-row sm:justify-between sm:px-6">
        <div className="text-center sm:text-left">
          <p className="font-bold text-gray-900 dark:text-white">Carouseten</p>
          <p className="text-sm text-gray-500 dark:text-gray-400">
            Discover beautiful destinations through interactive carousels.
          </p>
        </div>
        <p className="text-sm text-gray-500 dark:text-gray-400">
          &copy; {currentYear} Carouseten. Made with{' '}
          <a
