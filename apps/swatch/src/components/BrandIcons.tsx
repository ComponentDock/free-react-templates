...
function DribbbleIcon({ className }: IconProps) {
  return (
    ...
    >
      ...
      <path d="M5.6 5.4c4 4 8.6 5.4 14.8 5.2M3.5 13.8c6.4-.4 11.4 1.6 14.6 7.2M12.4 3.1c-2.4 5.4-2 11 1.2 16.4" />
    </svg>
  )
}

type SocialLink = { label: string; href: string; Icon: ComponentType<IconProps> }
