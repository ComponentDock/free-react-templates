  ...
  return (
    <header className="sticky top-0 z-50 border-b border-gray-100 bg-white/90 backdrop-blur transition-colors dark:border-gray-800 dark:bg-gray-950/90">
      <div className="mx-auto flex max-w-6xl items-center justify-between gap-4 px-4 py-4 sm:px-6">
        <a
          href="#home"
          className="flex items-center gap-2 font-sans text-xl font-bold uppercase tracking-[0.2em] text-heading dark:text-white"
        >
        ...
        <div className="flex items-center gap-3">
          <ButtonLink
            href="#contact"
            size="sm"
            className="hidden rounded-full bg-brand px-6 text-sm font-semibold text-white transition-colors hover:bg-white hover:text-brand lg:inline-flex"
          >
            Get Started
          </ButtonLink>
          ...
          <button
            ...
            aria-expanded={open}
            className="flex h-10 w-10 items-center justify-center rounded-lg border border-gray-300 text-body lg:hidden dark:border-gray-700 dark:text-gray-300"
          >
            {open ? (
