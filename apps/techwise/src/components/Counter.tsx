...
const counters = [
  { label: 'Year Of Experienced', target: 12 },
  { label: 'Happy Clients', target: 50 },
  { label: 'Projects Completed', target: 200 },
...
function CounterItem({ label, target }: { label: string; target: number }) {
  ...
  return (
    <div ref={ref} className="text-center">
      <span className="text-4xl font-bold text-brand">{value}</span>
  ...
  return (
    <section className="relative bg-dark-bg py-20 lg:py-[120px]">
      <div className="absolute inset-0">
        <img
          src="https://picsum.photos/seed/techwise-counter/1600/500"
          alt=""
          aria-hidden="true"
