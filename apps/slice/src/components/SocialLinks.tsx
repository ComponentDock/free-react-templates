      ...
      {socials.map((social) => (
        <li key={social.name}>
          <a
            ...
            className="flex h-10 w-10 items-center justify-center rounded-full border border-gray-200 bg-white text-primary-600 transition-colors hover:bg-primary-600 hover:text-white dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 dark:hover:bg-primary-600 dark:hover:text-white"
          >
