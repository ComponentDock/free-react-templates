  ...
  return (
    <footer id="contact" className="bg-gray-900 text-gray-300">
      <div className="container mx-auto grid gap-8 px-4 py-12 sm:grid-cols-2 lg:grid-cols-4">
        {/* Brand */}
        <div>
          <h3 className="mb-4 text-lg font-bold text-white">Trowel</h3>
        ...
        <div>
          ...
          <ul className="space-y-2">
            {serviceLinks.map((s) => (
              <li key={s}>
                <a href="#services" className="text-sm text-gray-400 hover:text-brand-400">
                  {s}
                </a>
              </li>
            ))}
        ...
        <div>
          ...
          <ul className="space-y-3">
            <li className="flex items-center gap-2 text-sm text-gray-400">
              ...
              123 Builder Avenue, Construction City, CC 12345
            </li>
            <li className="flex items-center gap-2 text-sm text-gray-400">
      ...
      <div className="border-t border-gray-800 py-4">
        <div className="container mx-auto flex flex-col items-center justify-between gap-2 px-4 text-xs text-gray-500 sm:flex-row">
          <p>&copy; {new Date().getFullYear()} Trowel. All rights reserved.</p>
          <p>
            More templates at{' '}
            <a
