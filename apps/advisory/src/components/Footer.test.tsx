...
describe('Footer', () => {
  ...
  it('renders Quick Links section', () => {
    ...
    for (const link of ['About', 'Services', 'Blog', 'Contact']) {
  ...
  it('renders Contact section', () => {
    ...
    expect(screen.getByText('123 Business Ave, Suite 100, New York, NY 10001')).toBeInTheDocument()
    expect(screen.getByText('+1 234 567 890')).toBeInTheDocument()
    expect(screen.getByText('info@advisory.com')).toBeInTheDocument()
  })
