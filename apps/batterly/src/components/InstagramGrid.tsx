      ...
      <div className="mx-auto max-w-6xl px-4">
        <div className="grid gap-10 md:grid-cols-2 items-center">
          ...
          <div>
            ...
            <a
              href="#instagram"
              className="mt-4 inline-block text-brand font-medium hover:text-brand-dark transition-colors"
            >
              @sweetcake
            </a>
          </div>
          ...
          <div className="grid grid-cols-3 gap-2">
            {INSTAGRAM_SEEDS.map((seed) => (
              <a key={seed} href="#instagram" className="group relative overflow-hidden rounded-md">
                <img
