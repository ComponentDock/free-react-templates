  ...
  return (
    <header className="sticky top-0 z-50 border-b border-gray-100 bg-white/90 backdrop-blur transition-colors dark:border-gray-800 dark:bg-gray-950/90">
      <div className="mx-auto flex max-w-6xl items-center justify-between gap-4 px-4 py-4 sm:px-6">
        <a
          href="#home"
          className="text-xl font-bold uppercase tracking-[0.2em] text-ink dark:text-white"
        >
        ...
        <div className="flex items-center gap-3">
          <ButtonLink
            href="#contact"
            size="sm"
            className="hidden rounded bg-brand px-6 uppercase tracking-wide text-white hover:bg-brand-dark lg:inline-flex"
          >
            Get Appointment
          </ButtonLink>
