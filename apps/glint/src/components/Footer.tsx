...
const hours = [
  { day: 'Monday', time: '8:00am - 12:00pm' },
  { day: 'Tuesday', time: '8:00am - 12:00pm' },
  { day: 'Wednesday', time: '8:00am - 12:00pm' },
  { day: 'Thursday', time: '8:00am - 12:00pm' },
  { day: 'Friday', time: '8:00am - 12:00pm' },
  { day: 'Sunday', time: '8:00am - 12:00pm' },
] as const
...
const footerLinks = ['Home', 'About us', 'Services', 'Blog', 'Contact'] as const
    ...
    <footer className="bg-footer text-white">
      <div className="mx-auto max-w-6xl px-4 py-16 sm:px-6">
        <div className="grid gap-12 md:grid-cols-3">
          ...
          {/* Services */}
          <div>
            <h5 className="mb-6 text-lg font-semibold uppercase tracking-wide text-brand">
              Our Services
            </h5>
          ...
          <div>
            ...
            <table className="w-full text-sm text-gray-400">
              <tbody>
                {hours.map((item) => (
                  <tr key={item.day} className="border-b border-gray-800">
