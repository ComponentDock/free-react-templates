...
describe('Carousel', () => {
  ...
  it('renders the first slide by default', () => {
    ...
    expect(
      screen.getByText('Discover breathtaking destinations and create unforgettable memories'),
    ).toBeInTheDocument()
  ...
  it('advances to next slide on right arrow click', () => {
    ...
    expect(screen.queryByText('Explore the World')).not.toBeInTheDocument()
  })
  ...
  it('displays a background image for the current slide', () => {
    ...
    expect(img.src).toContain('picsum.photos/seed/revolve-1')
  })
})
