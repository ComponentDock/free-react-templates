      ...
      <div className="mx-auto flex max-w-6xl items-center justify-between gap-4 px-4 py-4 sm:px-6">
        ...
        <div className="flex items-center gap-3">
          <ButtonLink
            href="#contact"
            size="sm"
            className="hidden rounded-lg bg-brand px-6 py-2 text-sm font-bold uppercase tracking-wide text-white hover:bg-brand-dark lg:inline-flex"
          >
            Make an Appointment
          </ButtonLink>
      ...
      {open && (
        ...
        >
          ...
          <ButtonLink
            href="#contact"
            size="sm"
            className="mt-2 block rounded-lg bg-brand px-6 py-2 text-center text-sm font-bold uppercase tracking-wide text-white hover:bg-brand-dark"
          >
            Make an Appointment
          </ButtonLink>
        </nav>
