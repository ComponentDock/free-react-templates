...
export function Navbar() {
  ...
  return (
    <>
      <header
        role="banner"
        className="fixed top-0 left-0 z-50 flex w-full items-center justify-between px-6 py-4 text-white"
      >
        ...
        <nav aria-label="social" className="flex items-center gap-4">
          ...
          <button
            ...
            className="ml-2 text-white transition-colors hover:text-white/80"
          >
      ...
      {menuOpen && (
        <>
          ...
          <nav
            ...
            className="fixed top-0 right-0 z-50 flex h-full w-72 flex-col bg-primary-dark px-8 pt-20"
          >
            <button
              type="button"
