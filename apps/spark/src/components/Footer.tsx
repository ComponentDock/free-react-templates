  ...
  return (
    <footer id="contact" className="bg-ink text-white">
      <div className="mx-auto grid max-w-6xl gap-10 px-4 py-14 sm:grid-cols-2 sm:px-6 lg:grid-cols-4">
        ...
        <div>
          ...
          <p className="mt-4 text-sm leading-relaxed text-gray-400">
            Spark helps teams ship faster with powerful tools, beautiful design, and seamless
            integrations.
          </p>
          <div className="mt-6 flex gap-4">
            <a
              ...
              aria-label="GitHub"
              className="flex h-9 w-9 items-center justify-center rounded-full border border-gray-600 text-gray-400 transition-colors hover:border-primary-400 hover:text-primary-400"
            >
        ...
        <div>
          ...
          <form onSubmit={handleSubmit} className="flex gap-2">
            <input
              ...
              className="flex-1 rounded-lg bg-gray-800 px-4 py-2 text-sm text-white placeholder-gray-500 outline-none focus:ring-2 focus:ring-primary-400"
            />
            <button
              type="submit"
      ...
      <div className="border-t border-gray-700 py-6 text-center text-sm text-gray-400">
        <p>
          &copy; {new Date().getFullYear()} Spark. All rights reserved. Built with{' '}
          <a
