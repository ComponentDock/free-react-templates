...
export function Footer() {
  return (
    <footer id="contact" className="bg-ink py-10">
      <div className="mx-auto max-w-6xl px-4">
        <div className="flex flex-col items-center justify-between gap-6 sm:flex-row">
          {/* Copyright */}
          <p className="text-sm text-white/70">
            &copy; {new Date().getFullYear()} Fotoroll. Made with{' '}
            <Heart className="mx-1 inline h-3 w-3 text-brand" aria-hidden="true" /> by a passionate
            photographer.
          </p>
