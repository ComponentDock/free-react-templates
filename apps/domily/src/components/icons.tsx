...
export function LinkedInIcon({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" className={className}>
      <path d="M6.5 8.8H3.6V21h2.9V8.8ZM5 7.4a1.7 1.7 0 1 0 0-3.4 1.7 1.7 0 0 0 0 3.4ZM21 14.4c0-3.2-1.7-5-4.2-5-1.9 0-2.8 1-3.3 1.8V8.8H10.6V21h2.9v-6.2c0-1.6.8-2.6 2.2-2.6 1.4 0 2 .9 2 2.6V21H21v-6.6Z" />
    </svg>
  )
}
