    ...
    <footer className="bg-coal py-16 text-white">
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="grid gap-10 lg:grid-cols-4">
          ...
          <div>
            <h3 className="font-display text-lg font-bold uppercase">Projects</h3>
            <ul className="mt-4 space-y-2 text-sm text-white/60">
              {projectLinks.map((label) => (
                <li key={label}>
                  <a href="#project" className="transition-colors hover:text-brand">
                    {label}
                  </a>
                </li>
              ))}
          ...
          <div>
            <h3 className="font-display text-lg font-bold uppercase">Contact us</h3>
            <ul className="mt-4 space-y-2 text-sm text-white/60">
              <li>Address: Hath of it fly signs bear be one blessed after</li>
              <li>Phone: +2 36 265 (8060)</li>
              <li>Email: info@terracotta.example</li>
            </ul>
          </div>
        ...
        <div className="mt-12 flex flex-col items-center justify-between gap-2 border-t border-white/10 pt-8 text-center text-xs text-white/50 sm:flex-row sm:text-left">
          <p>© 2026 Terracotta. All rights reserved.</p>
          <p>recreation of ColorLib Heaven</p>
        </div>
      </div>
    </footer>
  )
