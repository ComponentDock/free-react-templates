    ...
    <footer className="bg-footer-bg text-white/70">
      <div className="mx-auto max-w-6xl px-8 py-12">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
          ...
          <div>
            ...
            <p className="text-sm leading-relaxed">
              The largest classifieds platform. Buy, sell, and discover anything you want.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="flex gap-4">
              ...
              <a href="#" aria-label="X" className="hover:text-brand">
                <BrandIcon name="x" />
              </a>
        ...
        <div className="mt-8 border-t border-white/20 pt-6 text-center text-sm">
          <p>
            &copy; {new Date().getFullYear()} Adnest. More templates at{' '}
            <a
