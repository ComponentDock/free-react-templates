...
/* header — site name "Ascendly" (uppercase, indigo) + nav links (Home /
   About / Services / Blog / Contact, desktop-only) + dark-mode toggle.
   Dark mode flips a `.dark` class on <html> (class-based Tailwind variant). */
  ...
  return (
    <header className="sticky top-0 z-50 bg-white shadow-sm dark:bg-ink">
      <div className="mx-auto flex max-w-6xl items-center justify-between gap-4 px-4 py-4 sm:px-6">
        <a
          href="#home-section"
          className="text-[22px] font-black tracking-[0.15em] text-brand uppercase dark:text-white"
        >
          {BRAND}
        </a>
