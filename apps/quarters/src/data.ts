/** Copy + content data for the Quarters apartment-rental landing.
    Kept side-effect free so every entry is unit-testable. */
...
export const BRAND_NAME = 'Quarters'
...
export const COPYRIGHT = '© Quarters. All rights reserved.'
