      ...
      {socials.map((social) => (
        <li key={social.name}>
          <a
            ...
            className="flex h-10 w-10 items-center justify-center rounded-full bg-white/10 text-muted-light transition-colors hover:bg-primary-600 hover:text-white"
          >
