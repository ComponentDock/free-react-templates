const treatments = [
  {
    ...
    before: 'https://picsum.photos/seed/parapet-6/800/600',
    after: 'https://picsum.photos/seed/parapet-7/800/600',
  },
  {
    title: 'Kitchen Remodel',
    before: 'https://picsum.photos/seed/parapet-8/800/600',
    after: 'https://picsum.photos/seed/parapet-9/800/600',
  },
] as const
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-4 text-gray-600 dark:text-gray-400">
            See the dramatic before and after of our renovation and construction projects.
          </p>
        </div>
