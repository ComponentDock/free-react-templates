...
describe('Navbar', () => {
  it('renders the site name, links, phone number, and dark-mode toggle', () => {
    render(<Navbar />)
    expect(screen.getByRole('link', { name: /Edifice/i })).toBeInTheDocument()
    expect(screen.getByRole('link', { name: /Home/i })).toBeInTheDocument()
    expect(screen.getByRole('link', { name: /Feature/i })).toBeInTheDocument()
    ...
    expect(screen.getByText(/\+1 234 567 8910/i)).toBeInTheDocument()
