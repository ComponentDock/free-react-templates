      ...
      {socials.map((social) => (
        <li key={social.name}>
          <a
            ...
            className="flex h-10 w-10 items-center justify-center rounded-full border border-sky-200 bg-white text-gray-600 transition-colors hover:border-brand hover:text-brand dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 dark:hover:border-brand dark:hover:text-brand"
          >
