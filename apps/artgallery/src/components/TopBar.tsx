    ...
    <div className="bg-navy text-sm text-gray-300">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-2">
        <div className="flex items-center gap-4">
          <a href="#visit" className="flex items-center gap-1 transition-colors hover:text-accent">
            <Phone className="h-3 w-3" />
            <span>Visit Us</span>
          </a>
          <a href="#ticket" className="flex items-center gap-1 transition-colors hover:text-accent">
