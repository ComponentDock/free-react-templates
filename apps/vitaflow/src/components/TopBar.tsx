export function TopBar() {
  return (
    <div className="bg-[#1a1a1a] text-sm text-white/80">
      <div className="container mx-auto flex items-center justify-between px-4 py-2">
        <p className="m-0">
          Phone no:{' '}
          <a href="tel:+001234567" className="text-white hover:text-white/90">
            +00 1234 567
          </a>{' '}
          or email us:{' '}
          <a href="mailto:emailsample@email.com" className="text-white hover:text-white/90">
