...
export function Footer() {
  return (
    <footer className="bg-[#312b30] text-white">
        ...
        <div className="grid grid-cols-1 gap-12 md:grid-cols-4">
          <div>
            ...
            <p className="mt-4 text-sm leading-relaxed text-white/60">
              Experience luxury and elegance at RoxyGlow Hotel & Resort. Your comfort is our
              priority.
            </p>
          ...
          <div>
            <h3 className="font-display text-lg font-semibold">Have a Questions</h3>
