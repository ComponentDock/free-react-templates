...
const contactDetails = [
  { label: 'Phone', value: '(305) 555-0142', icon: Phone },
  { label: 'Email', value: 'studio@forma.design', icon: Mail },
  { label: 'Studio', value: '1200 Brickell Ave, Suite 400, Miami, FL 33131', icon: MapPin },
  {
    label: 'Studio Hours',
    value: 'Mon – Fri: 9:00 AM – 6:00 PM · Sat: 10:00 AM – 2:00 PM · Sun: Closed',
    icon: Clock,
  },
]
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-4 text-gray-600 dark:text-gray-400">
            Tell us about your space and we will get back to you within one business day with next
            steps.
          </p>
        </div>
            ...
            {sent ? (
              ...
              >
                ...
                <p className="mt-2 text-gray-600 dark:text-gray-300">
                  Our studio team will contact you within one business day to schedule your
                  consultation.
                </p>
              </div>
            ) : (
