...
const variants = [
  { name: 'Primary', colorClass: 'text-primary', label: 'Primary' },
  { name: 'Secondary', colorClass: 'text-secondary', label: 'Success' },
  { name: 'Tertiary', colorClass: 'text-tertiary', label: 'Danger' },
  { name: 'Quarternary', colorClass: 'text-quarternary', label: 'Warning' },
