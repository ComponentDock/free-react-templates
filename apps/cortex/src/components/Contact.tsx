...
const contactDetails = [
  { label: 'Phone', value: '(555) 345-6789', icon: Phone },
  { label: 'Email', value: 'agents@cortex.dev', icon: Mail },
  { label: 'Address', value: '200 Pioneer Square, Seattle, WA 98104', icon: MapPin },
  {
    label: 'Office Hours',
...
export function Contact() {
  ...
  return (
    <section id="contact" className="bg-gray-50 py-20 dark:bg-gray-900 lg:py-28">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-4 text-gray-600 dark:text-gray-400">
            Have questions about building AI agents? Our engineering team is ready to help you
          ...
          <aside className="space-y-4">
            {contactDetails.map((detail) => {
              ...
              return (
                ...
                >
                  <span className="flex h-11 w-11 flex-shrink-0 items-center justify-center rounded-xl bg-primary-50 text-primary-600 dark:bg-primary-900/40 dark:text-primary-400">
