...
const exploreLinks = ['About Us', 'Blog', 'Work'] as const
const quickLinks = ['Contact Us', 'Terms & Conditions', 'Privacy', 'Feedbacks'] as const
const categories = [
  'Graphic Design',
  'Web Design',
  'Branding & Printing',
...
export function Footer() {
  return (
    <footer id="contact" className="bg-dark-surface text-muted">
      <div className="mx-auto grid max-w-6xl gap-10 px-4 py-14 sm:grid-cols-2 sm:px-6 lg:grid-cols-4">
        {/* Brand */}
        <div>
          <h2 className="text-xl font-bold text-white">Oraxol</h2>
          ...
          <div className="mt-6 flex gap-3">
            <a
              ...
              rel="noreferrer"
              aria-label="Twitter"
              className="flex h-8 w-8 items-center justify-center rounded-full border border-white/20 text-muted transition-colors hover:border-white hover:text-white"
            >
              <svg
      ...
      <div className="border-t border-white/10">
        <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-2 px-4 py-5 sm:flex-row sm:px-6">
          <p className="text-xs text-muted">
            &copy; {new Date().getFullYear()} Oraxol. All rights reserved.
          </p>
          <p className="text-xs text-muted">
            Made with{' '}
            <a
