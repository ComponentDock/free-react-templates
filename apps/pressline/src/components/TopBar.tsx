...
export function TopBar() {
  return (
    <div className="border-b border-border bg-white text-sm text-smoke">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3">
        <div className="flex items-center gap-4">
          ...
          >
            ...
            <span>info@pressline.dev</span>
          </a>
          <a
            href="tel:+1234567890"
            className="hidden items-center gap-1.5 transition-colors hover:text-primary-300 sm:flex"
          >
        ...
        <div className="flex items-center gap-3">
          {socialLinks.map(({ icon: Icon, label, href }) => (
            <a
              ...
              href={href}
              aria-label={label}
              className="text-smoke transition-colors hover:text-primary-300"
            >
