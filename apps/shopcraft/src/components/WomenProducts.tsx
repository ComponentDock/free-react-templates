...
const womenProducts = [
  { name: 'Long Sleeve Shirt', price: '$150.00', image: 'shopcraft-women-1' },
  { name: 'Chiffon Dress', price: '$150.00', image: 'shopcraft-women-2' },
  { name: 'Summer Dress', price: '$150.00', image: 'shopcraft-women-3' },
  { name: 'Casual Dress', price: '$150.00', image: 'shopcraft-women-4' },
]
...
export function WomenProducts() {
  return (
    <section id="women" className="bg-white py-16 sm:py-24">
      <div className="mx-auto max-w-7xl px-4 sm:px-6">
        <div className="mb-12 text-center">
          <h2 className="text-3xl font-black text-heading">New realeased Products for Women</h2>
          ...
          {womenProducts.map((product) => (
            <div key={product.name} className="group text-center">
              ...
              <div className="mt-4">
                ...
                <p className="text-lg font-bold text-heading">{product.price}</p>
              </div>
            </div>
          ))}
        </div>
