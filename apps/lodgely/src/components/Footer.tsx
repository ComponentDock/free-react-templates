...
const aboutLinks = ['About Us', 'Terms & Conditions', 'Privacy Policy', 'Rooms'] as const
const roomLinks = ['The Rooms & Suites', 'About Us', 'Contact Us', 'Restaurant'] as const
    ...
    <footer className="bg-ink text-gray-400">
      <div className="mx-auto grid max-w-7xl gap-10 px-4 py-14 sm:grid-cols-2 lg:grid-cols-4 sm:px-6">
        ...
        <div>
          ...
          <p className="mb-4 text-sm">Sign up for our newsletter</p>
          <form onSubmit={handleSubmit} className="flex gap-2">
            ...
            <input
              ...
              placeholder="Email..."
              className="min-w-0 flex-1 rounded border border-gray-700 bg-gray-800 px-4 py-2.5 text-sm text-white placeholder:text-gray-500 focus:border-primary-400 focus:outline-none focus:ring-1 focus:ring-primary-400"
            />
            <button
              type="submit"
              aria-label="Subscribe"
              className="rounded bg-primary-400 px-4 py-2.5 text-white transition-colors hover:bg-primary-500"
            >
