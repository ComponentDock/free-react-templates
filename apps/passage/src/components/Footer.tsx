...
const quickLinks = ['Home', 'Services', 'Countries', 'Blog', 'Contact']
const serviceLinks = ['Visa Consultation', 'Work Permits', 'Student Visas', 'Permanent Residency']
    ...
    <footer className="bg-navy-dark text-white">
      <div className="mx-auto grid max-w-7xl grid-cols-1 gap-12 px-4 py-16 sm:px-6 md:grid-cols-2 lg:grid-cols-4">
        <div>
          ...
          <p className="mb-6 text-sm text-white/70">
            Your trusted partner for immigration services. We make your dream of living abroad a
            reality.
          </p>
        ...
        <div>
          ...
          <ul className="space-y-3">
            <li className="flex items-start gap-3 text-sm text-white/70">
              ...
              123 Migration Way, Suite 200, New York, NY 10001
            </li>
      ...
      <div className="border-t border-white/10 py-6 text-center">
        <p className="text-sm text-white/50">
          &copy; {new Date().getFullYear()} Passage. Made with{' '}
