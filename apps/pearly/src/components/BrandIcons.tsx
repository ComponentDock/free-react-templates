...
/* Brand icons (Facebook / Instagram / LinkedIn / YouTube) — lucide-react
   removed brand glyphs, so these are hand-written inline SVGs using the
   simple-icons path data. */
