...
/* Brand icons (Facebook, Twitter/X, Globe, Instagram) — lucide-react dropped brand
   logos; using inline SVGs instead. */
const FacebookIcon = () => (
...
const trainers: Trainer[] = [
  { name: 'Jordan Blake', role: 'Head Trainer', seed: 'fitcore-trainer-1' },
  { name: 'Casey Rivera', role: 'Strength Coach', seed: 'fitcore-trainer-2' },
  { name: 'Morgan Hayes', role: 'Fitness Director', seed: 'fitcore-trainer-3' },
]
