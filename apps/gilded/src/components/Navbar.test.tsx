...
describe('Navbar', () => {
  it('renders the site name, a Home link, and the Book Now CTA', () => {
    render(<Navbar />)
    expect(screen.getByRole('link', { name: /gilded/i })).toHaveAttribute('href', '#home')
  ...
  it('opens and closes the mobile menu', async () => {
    ...
    expect(within(mobileNav).getByRole('link', { name: /portfolio/i })).toBeInTheDocument()
