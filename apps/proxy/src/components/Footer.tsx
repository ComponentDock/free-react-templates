...
export function Footer() {
  ...
  return (
    <footer id="footer" className="bg-sky-500 py-16 text-white">
      <div className="mx-auto max-w-[1600px] px-6">
        <div className="mb-10 grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            <p className="mb-3 text-sm font-semibold text-white">Sign up for our newsletter</p>
            <form
              onSubmit={(e) => {
                e.preventDefault()
                setEmail('')
            ...
            >
              <input
                ...
                className="flex-1 rounded-l-full border-2 border-white/30 bg-transparent px-4 py-2 text-sm text-white placeholder-white/50 outline-none focus:border-white"
              />
              <button
                type="submit"
                className="rounded-r-full bg-white/20 px-4 text-white transition hover:bg-white/30"
        ...
        <div className="flex flex-col items-center justify-between gap-4 border-t border-white/20 pt-8 sm:flex-row">
          <p className="text-sm text-white/70">
            &copy; {new Date().getFullYear()} Proxy. More templates at{' '}
            <a
