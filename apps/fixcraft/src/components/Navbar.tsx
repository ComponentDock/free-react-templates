...
export function Navbar() {
  ...
  return (
    <header className="sticky top-0 z-50">
      {/* Top bar — phone + hours + socials (dark strip). */}
      <div className="bg-coal text-white">
        <div className="mx-auto flex max-w-6xl items-center justify-between gap-4 px-4 py-2 text-xs sm:px-6">
          <p className="hidden items-center gap-5 sm:flex">
            ...
            <span className="inline-flex items-center gap-2">Mon – Sat: 8am – 9pm</span>
          </p>
      ...
      {/* Main nav — logo, links, search, appointment CTA, mobile menu. */}
      <div className="border-b border-black/5 bg-white/95 backdrop-blur dark:border-white/10 dark:bg-gray-950/95">
        <div className="mx-auto flex max-w-6xl items-center justify-between gap-4 px-4 py-4 sm:px-6">
          ...
          >
            Fixcraft<span className="text-brand">.</span>
          </a>
          ...
          <div className="flex items-center gap-3">
            <a
              href="#appointment"
              className="hidden rounded bg-brand px-5 py-2.5 text-sm font-bold uppercase text-white transition-colors hover:bg-brand-dark sm:inline-block"
            >
              Appointment
            </a>
          ...
          <div className="fixed inset-0 z-50 flex flex-col bg-white lg:hidden dark:bg-gray-950">
            ...
            >
              ...
              <a
                href="#appointment"
                onClick={() => setOpen(false)}
                className="mt-4 rounded bg-brand px-5 py-3 text-center text-sm font-bold uppercase text-white transition-colors hover:bg-brand-dark"
              >
                Appointment
              </a>
            </nav>
