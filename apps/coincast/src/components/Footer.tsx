...
const latestNews = [
  ...
  'DeFi Market Sees Record Growth',
]
        ...
        <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-3">
          ...
          <div>
            <h3 className="text-lg font-bold">
              Coin<span className="text-brand">Cast</span>
            </h3>
            <p className="mt-3 text-sm leading-relaxed text-white/60">
              We are a leading cryptocurrency agency providing comprehensive solutions for digital
              asset management, trading, and blockchain development.
            </p>
      ...
      <div className="border-t border-white/10">
        <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-4 px-4 py-4 sm:flex-row">
          <p className="text-sm text-white/50">
            &copy; {new Date().getFullYear()} CoinCast. All rights reserved. Made with{' '}
            <a
