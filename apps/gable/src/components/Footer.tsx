...
const archiveLinks = ['January 2026', 'December 2025', 'November 2025'] as const
    ...
    <footer id="contact" className="bg-coal py-16 text-white">
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
          <div>
            <h3 className="font-display text-lg font-bold uppercase text-brand">About</h3>
            <p className="mt-4 text-sm leading-relaxed text-white/60">
              Gable is an architecture studio crafting measured, light-filled spaces — from home
              interiors to complete buildings.
            </p>
          ...
          <div>
            <h3 className="font-display text-lg font-bold uppercase text-brand">Navigation</h3>
          ...
          <div>
            <h3 className="font-display text-lg font-bold uppercase text-brand">Archives</h3>
            <ul className="mt-4 space-y-2 text-sm text-white/60">
              {archiveLinks.map((label) => (
                <li key={label}>
          ...
          <div>
            ...
            <p className="mt-4 text-sm leading-relaxed text-white/60">
              Sign up for our newsletter to get the latest project updates.
            </p>
        ...
        <div className="mt-12 flex flex-col items-center justify-between gap-2 border-t border-white/10 pt-8 text-center text-xs text-white/50 sm:flex-row sm:text-left">
          <p>© 2026 Gable. All rights reserved.</p>
          <p>recreation of ColorLib Kd</p>
        </div>
      </div>
    </footer>
  )
