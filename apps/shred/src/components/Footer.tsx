...
/* Footer — black #000 footer with four columns (About, Links, Services,
   Have a Questions?), social circles and the centered copyright row with
   the Component Dock credit link. */
    ...
    <footer className="bg-ink py-20 text-white">
      <div className="mx-auto max-w-7xl px-4">
        <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-4">
          <div>
            <h3 className="text-lg font-bold">About {BRAND}.</h3>
              ...
              {SOCIALS.map((social) => {
                ...
                return (
                  <a
                    ...
                    className={cn(
                      'inline-flex h-10 w-10 items-center justify-center rounded-full border border-white/20 text-white/70 transition-colors',
