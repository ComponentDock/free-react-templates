...
const galleryItems: GalleryItem[] = [
  { seed: 'fitcraft-gallery-1', title: 'Strength Zone', category: 'Fitness, Body' },
  { seed: 'fitcraft-gallery-2', title: 'Cardio Studio', category: 'Cardio, Endurance' },
  { seed: 'fitcraft-gallery-3', title: 'Free Weights', category: 'Strength, Power' },
  { seed: 'fitcraft-gallery-4', title: 'Group Classes', category: 'Classes, Community' },
  { seed: 'fitcraft-gallery-5', title: 'Recovery Area', category: 'Wellness, Recovery' },
  { seed: 'fitcraft-gallery-6', title: 'Training Floor', category: 'Equipment, Training' },
]
